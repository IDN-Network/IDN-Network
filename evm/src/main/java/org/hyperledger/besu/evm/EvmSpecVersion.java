...
import org.idnecology.idn.datatypes.HardforkId.MainnetHardforkId;
...
public enum EvmSpecVersion {
  ...
  /**
   * What is the "default" version of EVM that should be made. Newer versions of Idn will adjust
   * this to reflect mainnet fork development.
   *
   * @return the current mainnet for as of the release of this version of Idn
   */
