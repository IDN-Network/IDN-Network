 ...
 */
package org.idnecology.idn.plugin.services.privacy;
...
public interface PrivacyPluginPayloadProvider {
  ...
  /**
   * When processing privacy marker transactions idn needs to know how to process them. The plugin
   ...
   * <br>
   * Note! Any exceptions thrown in this method with cause idn to crash and stop processing blocks
   *
