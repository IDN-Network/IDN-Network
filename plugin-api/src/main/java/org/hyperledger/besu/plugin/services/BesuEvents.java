...
import org.idnecology.idn.plugin.data.BadBlockCause;
...
/**
 * This service allows plugins to attach to various events during the normal operation of Idn.
 *
 ...
 * </ul>
 */
public interface IdnEvents extends IdnService {
  ...
  /**
   * Remove the blockAdded listener from idn notifications.
   *
  ...
  /**
   * Remove the block added listener from idn notifications.
   *
  ...
  /**
   * Remove the block reorg listener from idn notifications.
   *
  ...
  /**
   * Remove the transactionDropped listener from idn notifications.
   *
  ...
  /**
   * Remove the sync status listener from idn notifications.
   *
