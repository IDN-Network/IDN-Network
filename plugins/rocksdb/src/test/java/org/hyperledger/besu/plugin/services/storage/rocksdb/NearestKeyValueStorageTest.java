...
import org.idnecology.idn.plugin.services.storage.SegmentedKeyValueStorage.NearestKeyValue;
...
public class NearestKeyValueStorageTest {
  ...
  private static IdnConfiguration commonConfiguration;
  ...
  private static void mockCommonConfiguration(final Path tempDataDir) {
    commonConfiguration = mock(IdnConfiguration.class);
