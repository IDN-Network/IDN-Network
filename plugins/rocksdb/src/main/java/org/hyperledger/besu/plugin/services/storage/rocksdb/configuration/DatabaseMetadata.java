 ...
 */
package org.idnecology.idn.plugin.services.storage.rocksdb.configuration;
...
public class DatabaseMetadata {
   ...
   *
   * @param idnConfiguration idn configuration
   * @return the metadata to use for new db
   */
  public static DatabaseMetadata defaultForNewDb(final IdnConfiguration idnConfiguration) {
    return new DatabaseMetadata(
        BaseVersionedStorageFormat.defaultForNewDB(
            idnConfiguration.getDataStorageConfiguration()));
  }
