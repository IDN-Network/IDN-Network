...
import org.idnecology.idn.components.EnclaveModule;
...
public class PrivacyReorgTest {
  ...
  private final IdnController idnController = component.getIdnController();
  ...
  public void privacyGroupHeadIsTracked() {
    ...
    final ProtocolContext protocolContext = idnController.getProtocolContext();
    ...
    appendBlock(idnController, blockchain, protocolContext, firstBlock);
    ...
    appendBlock(idnController, blockchain, protocolContext, secondBlock);
  ...
  public void reorgToChainAtEqualHeight() {
    ...
    var importResult = appendBlock(idnController, blockchain, protocolContext, firstBlock);
    ...
    appendBlock(idnController, blockchain, protocolContext, forkBlock);
  ...
  public void reorgToLongerChain() {
    ...
    appendBlock(idnController, blockchain, protocolContext, forkBlock);
    appendBlock(idnController, blockchain, protocolContext, secondForkBlock);
    ...
    appendBlock(idnController, blockchain, protocolContext, thirdForkBlock);
  ...
  @Component(
      modules = {
        ...
        PrivacyReorgTest.PrivacyReorgTestIdnControllerModule.class,
  ...
  interface PrivacyReorgTestComponent extends IdnComponent {
  ...
  @Module
  static class PrivacyReorgTestIdnControllerModule {
