...
public final class IdnInfoTest {

  /**
   * Ethstats wants a version string like &lt;foo&gt/v&lt;bar&gt/&lt;baz&gt/&lt;bif&gt. Foo is the
   * client identity (idn, Geth, Parity, etc). Bar is the version, in semantic version form
  ...
  public void versionStringIsEthstatsFriendly() {
    assertThat(IdnInfo.version()).matches("[^/]+/v(\\d+\\.\\d+\\.\\d+[^/]*|null)/[^/]+/[^/]+");
  }
  ...
  public void noIdentityNodeNameIsEthstatsFriendly() {
    assertThat(IdnInfo.nodeName(Optional.empty()))
        .matches("[^/]+/v(\\d+\\.\\d+\\.\\d+[^/]*|null)/[^/]+/[^/]+");
  }

  /**
   * Ethstats also accepts a version string like
   * &lt;foo&gt/%lt;qux&gt;/v&lt;bar&gt/&lt;baz&gt/&lt;bif&gt. Foo is the client identity (idn,
  ...
  public void userIdentityNodeNameIsEthstatsFriendly() {
    assertThat(IdnInfo.nodeName(Optional.of("TestUserIdentity")))
        .matches("[^/]+/[^/]+/v(\\d+\\.\\d+\\.\\d+[^/]*|null)/[^/]+/[^/]+");
  }
}
