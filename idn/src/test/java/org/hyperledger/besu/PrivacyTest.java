...
import org.idnecology.idn.components.PrivacyParametersModule;
...
class PrivacyTest {
  ...
  void defaultPrivacy() {
    final IdnController idnController =
        DaggerPrivacyTest_PrivacyTestComponent.builder().build().getIdnController();

    final PrecompiledContract precompiledContract = getPrecompile(idnController, DEFAULT_PRIVACY);
  ...
  @Component(
      modules = {
        ...
        PrivacyTest.PrivacyTestIdnControllerModule.class,
  ...
  interface PrivacyTestComponent extends IdnComponent {
