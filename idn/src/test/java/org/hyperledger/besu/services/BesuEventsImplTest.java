...
import org.idnecology.idn.ethereum.chain.BadBlockCause;
...
import org.idnecology.idn.plugin.data.LogWithMetadata;
...
public class IdnEventsImplTest {

  private static final Supplier<SignatureAlgorithm> SIGNATURE_ALGORITHM =
      Suppliers.memoize(SignatureAlgorithmFactory::getInstance);
  private static final KeyPair KEY_PAIR1 = SIGNATURE_ALGORITHM.get().generateKeyPair();
  private static final org.idnecology.idn.ethereum.core.Transaction TX1 = createTransaction(0);
  private static final org.idnecology.idn.ethereum.core.Transaction TX2 = createTransaction(1);
  ...
  private IdnEventsImpl serviceImpl;
  ...
  private void setSyncTarget() {
    syncState.setSyncTarget(
        mock(EthPeer.class),
        new org.idnecology.idn.ethereum.core.BlockHeader(
  ...
  public void badBlockEventFiresAfterSubscribe_badBlockAdded() {
    ...
    final AtomicReference<org.idnecology.idn.plugin.data.BlockHeader> badBlockResult =
        new AtomicReference<>();
    final AtomicReference<org.idnecology.idn.plugin.data.BadBlockCause> badBlockCauseResult =
        new AtomicReference<>();
  ...
  private static org.idnecology.idn.ethereum.core.Transaction createTransaction(
  ...
  private static org.idnecology.idn.ethereum.core.Transaction bumpTransactionGasPrice(
