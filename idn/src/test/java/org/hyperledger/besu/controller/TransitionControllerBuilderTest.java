...
import org.idnecology.idn.consensus.clique.BlockHeaderValidationRulesetFactory;
...
public class TransitionControllerBuilderTest {
  ...
  CliqueIdnControllerBuilder cliqueBuilder = new CliqueIdnControllerBuilder();
  IdnControllerBuilder powBuilder = new MainnetIdnControllerBuilder();
  MergeIdnControllerBuilder postMergeBuilder = new MergeIdnControllerBuilder();
  ...
  TransitionCoordinator buildTransitionCoordinator(
      final IdnControllerBuilder preMerge, final MergeIdnControllerBuilder postMerge) {
    var builder = new TransitionIdnControllerBuilder(preMerge, postMerge);
