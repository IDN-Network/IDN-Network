...
public abstract class AbstractBftIdnControllerBuilderTest {

  protected IdnControllerBuilder bftIdnControllerBuilder;
  ...
  protected abstract IdnControllerBuilder createBftControllerBuilder();

  @Test
  public void miningParametersBlockPeriodSecondsIsUpdatedOnTransition() {
    final var idnController = bftIdnControllerBuilder.build();
