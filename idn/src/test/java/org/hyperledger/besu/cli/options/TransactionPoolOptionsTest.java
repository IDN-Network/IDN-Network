...
import static org.idnecology.idn.ethereum.eth.transactions.TransactionPoolConfiguration.Implementation.LAYERED;
import static org.idnecology.idn.ethereum.eth.transactions.TransactionPoolConfiguration.Implementation.LEGACY;
import static org.idnecology.idn.ethereum.eth.transactions.TransactionPoolConfiguration.Implementation.SEQUENCED;

import org.idnecology.idn.cli.converter.DurationMillisConverter;
...
public class TransactionPoolOptionsTest
  ...
  public void eth65TrxAnnouncedBufferingPeriodWithInvalidInputShouldFail() {
    internalTestFailure(
        "Invalid value for option '--Xeth65-tx-announced-buffering-period-milliseconds': cannot convert 'acbd' to Duration (org.idnecology.idn.cli.converter.exception.DurationConversionException: 'acbd' is not a long)",
        "--Xeth65-tx-announced-buffering-period-milliseconds",
        "acbd");
  }
  ...
  public void eth65TrxAnnouncedBufferingPeriodWithInvalidInputShouldFail2() {
    internalTestFailure(
        "Invalid value for option '--Xeth65-tx-announced-buffering-period-milliseconds': cannot convert '-1' to Duration (org.idnecology.idn.cli.converter.exception.DurationConversionException: negative value '-1' is not allowed)",
        "--Xeth65-tx-announced-buffering-period-milliseconds",
        "-1");
  }
  ...
  @Override
  protected TransactionPoolOptions getOptionsFromIdnCommand(final TestIdnCommand idnCommand) {
    return idnCommand.getTransactionPoolOptions();
  }
