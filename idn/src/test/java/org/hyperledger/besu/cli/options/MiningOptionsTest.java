...
import org.idnecology.idn.ethereum.core.ImmutableMiningConfiguration.Unstable;
...
public class MiningOptionsTest extends AbstractCLIOptionsTest<MiningConfiguration, MiningOptions> {
  ...
  @Test
  public void idnDoesNotStartInMiningModeIfCoinbaseNotSet() {
    internalTestFailure(
  ...
  @Override
  protected MiningOptions getOptionsFromIdnCommand(final TestIdnCommand idnCommand) {
    return idnCommand.getMiningOptions();
  }
  ...
  private MiningConfiguration runtimeConfiguration(
      final TestIdnCommand idnCommand, final MiningConfiguration miningConfiguration) {
    if (idnCommand.getGenesisConfigOptions().isPoa()) {
