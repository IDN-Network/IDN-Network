 ...
 */
package org.idnecology.idn.cli.options.stable;
...
import org.idnecology.idn.cli.options.AbstractCLIOptionsTest;
...
public class DataStorageOptionsTest
  ...
  @Override
  protected DataStorageOptions getOptionsFromIdnCommand(final TestIdnCommand idnCommand) {
    return idnCommand.getDataStorageOptions();
  }
}
