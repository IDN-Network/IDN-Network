...
import static org.idnecology.idn.cli.DefaultCommandValues.DEFAULT_CONTINUE_ON_PLUGIN_ERROR_OPTION_NAME;
import static org.idnecology.idn.cli.DefaultCommandValues.DEFAULT_PLUGINS_EXTERNAL_ENABLED_OPTION_NAME;
import static org.idnecology.idn.cli.DefaultCommandValues.DEFAULT_PLUGINS_OPTION_NAME;

import org.idnecology.idn.cli.converter.PluginInfoConverter;
...
public class PluginsConfigurationOptions implements CLIOptions<PluginConfiguration> {
  ...
  @CommandLine.Option(
      ...
      description =
          "Allow Idn startup even if any plugins fail to initialize correctly (default: ${DEFAULT-VALUE})",
      defaultValue = "false",
      arity = "1")
