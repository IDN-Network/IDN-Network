...
import static org.idnecology.idn.cli.subcommands.operator.OperatorSubCommand.COMMAND_NAME;
...
public class OperatorSubCommand implements Runnable {
  ...
  @ParentCommand
  IdnCommand parentCommand; // Picocli injects reference to parent command
