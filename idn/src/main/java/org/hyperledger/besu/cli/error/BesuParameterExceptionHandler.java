...
/** The custom parameter exception handler for Idn PicoCLI. */
public class IdnParameterExceptionHandler implements CommandLine.IParameterExceptionHandler {

  private final Supplier<String> levelSupplier;

  /**
   * Instantiates a new Idn parameter exception handler.
   *
   * @param levelSupplier the logging level supplier
   */
  public IdnParameterExceptionHandler(final Supplier<String> levelSupplier) {
