...
import static org.idnecology.idn.cli.DefaultCommandValues.MANDATORY_PATH_FORMAT_HELP;
...
public class NodePrivateKeyFileOption {
  ...
  @CommandLine.Option(
      ...
      description =
          "The node's private key file (default: a file named \"key\" in the Idn data directory)")
