...
import static org.idnecology.idn.ethereum.api.graphql.GraphQLConfiguration.DEFAULT_GRAPHQL_HTTP_PORT;
...
/** Handles configuration options for the GraphQL HTTP service in Idn. */
