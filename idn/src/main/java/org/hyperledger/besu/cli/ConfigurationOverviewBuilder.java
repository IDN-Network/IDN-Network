...
public class ConfigurationOverviewBuilder {
  ...
  public String build() {
    ...
    lines.add("Idn version " + IdnInfo.class.getPackage().getImplementationVersion());
    lines.add("");
    ...
    if (idnPluginContext != null) {
      lines.addAll(idnPluginContext.getPluginsSummaryLog());
    }
   ...
   *
   * @param idnPluginContext the plugin context
   */
  public void setPluginContext(final IdnPluginContextImpl idnPluginContext) {
