...
import org.idnecology.idn.ethereum.permissioning.PermissioningConfigurationBuilder;
...
/** Handles configuration options for permissions in Idn. */
...
public class PermissionsOptions {
  ...
  @CommandLine.Option(
      ...
      description =
          "Node permissioning config TOML file (default: a file named \"permissions_config.toml\" in the Idn data folder)")
  ...
  @CommandLine.Option(
      ...
      description =
          "Account permissioning config TOML file (default: a file named \"permissions_config.toml\" in the Idn data folder)")
