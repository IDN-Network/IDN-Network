...
import static org.idnecology.idn.cli.DefaultCommandValues.MANDATORY_HOST_FORMAT_HELP;
import static org.idnecology.idn.cli.DefaultCommandValues.MANDATORY_INTEGER_FORMAT_HELP;
import static org.idnecology.idn.cli.DefaultCommandValues.MANDATORY_PORT_FORMAT_HELP;
import static org.idnecology.idn.metrics.IdnMetricCategory.DEFAULT_METRIC_CATEGORIES;
import static org.idnecology.idn.metrics.MetricsProtocol.PROMETHEUS;
import static org.idnecology.idn.metrics.prometheus.MetricsConfiguration.DEFAULT_METRICS_PORT;
import static org.idnecology.idn.metrics.prometheus.MetricsConfiguration.DEFAULT_METRICS_PUSH_PORT;
...
public class MetricsOptions implements CLIOptions<MetricsConfiguration.Builder> {
  ...
  @CommandLine.Option(
      ...
      arity = "1")
  private String metricsPrometheusJob = "idn-client";
