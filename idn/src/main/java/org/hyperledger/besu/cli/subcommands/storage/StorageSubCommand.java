...
import static org.idnecology.idn.cli.subcommands.storage.StorageSubCommand.COMMAND_NAME;
...
import static org.idnecology.idn.ethereum.chain.VariablesStorage.Keys.FORK_HEADS;
import static org.idnecology.idn.ethereum.chain.VariablesStorage.Keys.SAFE_BLOCK_HASH;
import static org.idnecology.idn.ethereum.chain.VariablesStorage.Keys.SEQ_NO_STORE;
...
import org.idnecology.idn.plugin.services.storage.KeyValueStorageTransaction;
...
public class StorageSubCommand implements Runnable {
  ...
  static class RevertVariablesStorage implements Runnable {
    ...
    public void run() {
      ...
      final var storageProvider = createIdnController().getStorageProvider();

      revert(storageProvider);
    }

    private IdnController createIdnController() {
      return parentCommand.idnCommand.buildController();
    }
