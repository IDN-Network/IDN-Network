...
import static org.idnecology.idn.cli.config.NetworkName.EPHEMERY;
...
import static org.idnecology.idn.cli.util.CommandLineUtils.isOptionSet;
import static org.idnecology.idn.controller.IdnController.DATABASE_PATH;
import static org.idnecology.idn.ethereum.api.jsonrpc.authentication.EngineAuthService.EPHEMERAL_JWT_FILE;
...
import org.idnecology.idn.cli.config.ProfilesCompletionCandidates;
import org.idnecology.idn.cli.custom.JsonRPCAllowlistHostsProperty;
import org.idnecology.idn.cli.error.IdnExecutionExceptionHandler;
import org.idnecology.idn.cli.error.IdnParameterExceptionHandler;
import org.idnecology.idn.cli.options.ApiConfigurationOptions;
import org.idnecology.idn.cli.options.ChainPruningOptions;
import org.idnecology.idn.cli.options.DnsOptions;
import org.idnecology.idn.cli.options.EngineRPCConfiguration;
import org.idnecology.idn.cli.options.EngineRPCOptions;
import org.idnecology.idn.cli.options.EthProtocolOptions;
import org.idnecology.idn.cli.options.EthstatsOptions;
import org.idnecology.idn.cli.options.EvmOptions;
import org.idnecology.idn.cli.options.GraphQlOptions;
import org.idnecology.idn.cli.options.InProcessRpcOptions;
import org.idnecology.idn.cli.options.IpcOptions;
import org.idnecology.idn.cli.options.JsonRpcHttpOptions;
import org.idnecology.idn.cli.options.LoggingLevelOption;
import org.idnecology.idn.cli.options.MetricsOptions;
import org.idnecology.idn.cli.options.MiningOptions;
import org.idnecology.idn.cli.options.NatOptions;
import org.idnecology.idn.cli.options.NativeLibraryOptions;
...
import org.idnecology.idn.cli.options.PermissionsOptions;
import org.idnecology.idn.cli.options.PluginsConfigurationOptions;
import org.idnecology.idn.cli.options.PrivacyPluginOptions;
import org.idnecology.idn.cli.options.RPCOptions;
import org.idnecology.idn.cli.options.RpcWebsocketOptions;
...
import org.idnecology.idn.cli.options.storage.DiffBasedSubStorageOptions;
import org.idnecology.idn.cli.options.unstable.QBFTOptions;
import org.idnecology.idn.cli.presynctasks.PreSynchronizationTaskRunner;
import org.idnecology.idn.cli.presynctasks.PrivateDatabaseMigrationPreSyncTask;
import org.idnecology.idn.cli.subcommands.PasswordSubCommand;
import org.idnecology.idn.cli.subcommands.PublicKeySubCommand;
import org.idnecology.idn.cli.subcommands.TxParseSubCommand;
import org.idnecology.idn.cli.subcommands.ValidateConfigSubCommand;
import org.idnecology.idn.cli.subcommands.blocks.BlocksSubCommand;
import org.idnecology.idn.cli.subcommands.operator.OperatorSubCommand;
import org.idnecology.idn.cli.subcommands.rlp.RLPSubCommand;
import org.idnecology.idn.cli.subcommands.storage.StorageSubCommand;
import org.idnecology.idn.cli.util.IdnCommandCustomFactory;
import org.idnecology.idn.cli.util.CommandLineUtils;
import org.idnecology.idn.cli.util.ConfigDefaultValueProviderStrategy;
...
import org.idnecology.idn.crypto.Blake2bfMessageDigest;
...
import org.idnecology.idn.ethereum.core.MiningParametersMetrics;
import org.idnecology.idn.ethereum.core.PrivacyParameters;
import org.idnecology.idn.ethereum.core.VersionMetadata;
...
import org.idnecology.idn.ethereum.p2p.peers.StaticNodesParser;
...
import org.idnecology.idn.ethereum.privacy.storage.keyvalue.PrivacyKeyValueStorageProvider;
...
import org.idnecology.idn.ethereum.worldstate.DiffBasedSubStorageConfiguration;
import org.idnecology.idn.ethereum.worldstate.ImmutableDataStorageConfiguration;
import org.idnecology.idn.ethereum.worldstate.ImmutableDiffBasedSubStorageConfiguration;
import org.idnecology.idn.evm.precompile.AbstractAltBnPrecompiledContract;
import org.idnecology.idn.evm.precompile.BigIntegerModularExponentiationPrecompiledContract;
import org.idnecology.idn.evm.precompile.KZGPointEvalPrecompiledContract;
import org.idnecology.idn.metrics.IdnMetricCategory;
import org.idnecology.idn.metrics.MetricCategoryRegistryImpl;
import org.idnecology.idn.metrics.MetricsProtocol;
...
import org.idnecology.idn.metrics.vertx.VertxMetricsAdapterFactory;
...
import org.idnecology.idn.plugin.services.TraceService;
...
import org.idnecology.idn.plugin.services.p2p.P2PService;
...
import org.idnecology.idn.services.BlockSimulatorServiceImpl;
import org.idnecology.idn.services.BlockchainServiceImpl;
import org.idnecology.idn.services.MiningServiceImpl;
import org.idnecology.idn.services.P2PServiceImpl;
...
import org.idnecology.idn.services.RlpConverterServiceImpl;
...
import org.idnecology.idn.services.SynchronizationServiceImpl;
import org.idnecology.idn.services.TraceServiceImpl;
...
import org.idnecology.idn.util.EphemeryGenesisUpdater;
...
import org.idnecology.idn.util.PermissioningConfigurationValidator;
import org.idnecology.idn.util.number.Fraction;
import org.idnecology.idn.util.number.Percentage;
import org.idnecology.idn.util.number.PositiveNumber;
...
/** Represents the main Idn CLI command that runs the Idn Ethereum client full node. */
@SuppressWarnings("FieldCanBeLocal") // because Picocli injected fields report false positives
@Command(
    description = "This command runs the Idn Ethereum client full node.",
    ...
    footerHeading = "%nIdn is licensed under the Apache License 2.0%n",
    footer = {
...
public class IdnCommand implements DefaultCommandValues, Runnable {
  ...
  private final Function<IdnController, JsonBlockImporter> jsonBlockImporterFactory;
  ...
  private final IdnController.Builder controllerBuilder;
  private final IdnPluginContextImpl idnPluginContext;
  ...
  @CommandLine.Option(
      ...
      description = "The path to Idn data directory (default: ${DEFAULT-VALUE})")
  ...
  private String idnUserName = "idn";
  ...
  private IdnComponent idnComponent;
  ...
  @Option(
      ...
      description =
          "Perform compatibility checks between the version of Idn being started and the version of Idn that last started with this data directory. (default: ${DEFAULT-VALUE})")
  ...
  private IdnConfigurationImpl pluginCommonConfiguration;
  ...
  /**
   * Idn command constructor.
   *
   * @param rlpBlockImporter RlpBlockImporter supplier
   * @param jsonBlockImporterFactory instance of {@code Function<IdnController, JsonBlockImporter>}
   ...
   * @param controllerBuilder instance of IdnController.Builder
   * @param idnPluginContext instance of IdnPluginContextImpl
  ...
  public IdnCommand(
      ...
      final IdnController.Builder controllerBuilder,
  ...
  /**
   * Overloaded Idn command constructor visible for testing.
   *
   * @param rlpBlockImporter RlpBlockImporter supplier
   * @param jsonBlockImporterFactory instance of {@code Function<IdnController, JsonBlockImporter>}
   * @param era1BlockImporter Era1BlockImporter supplier
  ...
  protected IdnCommand(
    ...
    if (idnPluginContext.getService(IdnConfigurationImpl.class).isPresent()) {
      this.pluginCommonConfiguration =
          idnPluginContext.getService(IdnConfigurationImpl.class).get();
    } else {
      this.pluginCommonConfiguration = new IdnConfigurationImpl();
      idnPluginContext.addService(IdnConfiguration.class, this.pluginCommonConfiguration);
    }
  ...
  /**
   * Parse Idn command line arguments. Visible for testing.
   *
   ...
   * @param args arguments to Idn command
   ...
   * @param idnComponent The Idn component.
   * @param args The command line arguments.
   * @return The execution result status code.
   */
  public int parse(
      final IExecutionStrategy resultHandler,
      final IdnParameterExceptionHandler parameterExceptionHandler,
      final IdnExecutionExceptionHandler executionExceptionHandler,
      final InputStream in,
      final IdnComponent idnComponent,
      final String... args) {
    if (idnComponent == null) {
      throw new IllegalArgumentException("IdnComponent must be provided");
    }
    this.idnComponent = idnComponent;
  ...
  private IExecutionStrategy createPluginRegistrationTask(final IExecutionStrategy nextStep) {
    return parseResult -> {
      idnPluginContext.initialize(PluginsConfigurationOptions.fromCommandLine(commandLine));
  ...
  public void toCommandLine() {
    commandLine =
        new CommandLine(this, new IdnCommandCustomFactory(idnPluginContext))
  ...
  public void run() {
    ...
    try {
      ...
      if (printPathsAndExit) {
        ...
        checkPermissionsAndPrintPaths(idnUserName);
      ...
      logger.info("Starting Idn");

      // Need to create vertx after cmdline has been parsed, such that metricsSystem is configurable
      vertx = createVertx(createVertxOptions(idnComponent.getMetricsSystem()));
      ...
      idnPluginContext.afterExternalServicesMainLoop();

      runner.awaitStop();

    } catch (final Exception e) {
      logger.error("Failed to start Idn", e);
  ...
  private void checkPermissions(final Path path, final String idnUser, final boolean readOnly) {
    try {
      // Get the permissions of the file
      // check if idn user is the owner - get owner permissions if yes
      // else, check if idn user and owner are in the same group - if yes, check the group
      // permission
      ...
      // Check if idn is the owner
      if (owner.getName().equals(idnUser)) {
        // Owner permissions
        ...
        // Check if idn user belongs to this group
        boolean isMember = isGroupMember(idnUserName, group);
  ...
  @VisibleForTesting
  void setIdnConfiguration(final IdnConfigurationImpl pluginCommonConfiguration) {
  ...
  private void preparePlugins() {
    ...
    metricCategoryRegistry.addCategories(IdnMetricCategory.class);
    ...
    idnPluginContext.addService(PrivacyPluginService.class, privacyPluginService);
    ...
    rocksDBPlugin.register(idnPluginContext);
    new InMemoryStoragePlugin().register(idnPluginContext);
  ...
  private void preSynchronization() {
    preSynchronizationTaskRunner.runTasks(idnController);
  }
  ...
  private void startPlugins(final Runner runner) {
    blockchainServiceImpl.init(
        idnController.getProtocolContext().getBlockchain(), idnController.getProtocolSchedule());
    transactionSimulationServiceImpl.init(
        idnController.getProtocolContext().getBlockchain(),
        idnController.getTransactionSimulator());
    ...
    idnPluginContext.addService(MetricsSystem.class, getMetricsSystem());
    ...
    idnPluginContext.addService(
        ...
        new SynchronizationServiceImpl(
            idnController.getSynchronizer(),
            idnController.getProtocolContext(),
            idnController.getProtocolSchedule(),
            idnController.getSyncState(),
            idnController.getProtocolContext().getWorldStateArchive()));

    idnPluginContext.addService(P2PService.class, new P2PServiceImpl(runner.getP2PNetwork()));
    ...
    idnPluginContext.addService(
        ...
        new RlpConverterServiceImpl(idnController.getProtocolSchedule()));
    ...
    idnController.getAdditionalPluginServices().appendPluginServices(idnPluginContext);
  ...
  private void setReleaseMetrics() {
    idnComponent
        ...
        .labels(() -> 1, IdnInfo.version());
  }

  /**
   * Configure logging framework for Idn
   *
  ...
  /**
   * Builds IdnController
   *
   * @return instance of IdnController
   */
  public IdnController buildController() {
    try {
  ...
  /**
   * Builds IdnControllerBuilder which can be used to build IdnController
   *
   * @return instance of IdnControllerBuilder
   */
  public IdnControllerBuilder setupControllerBuilder() {
    ...
    IdnControllerBuilder idnControllerBuilder =
        controllerBuilder
            ...
            .metricsSystem((ObservableMetricsSystem) idnComponent.getMetricsSystem())
    ...
    if (DataStorageFormat.BONSAI.equals(getDataStorageConfiguration().getDataStorageFormat())) {
      ...
      idnControllerBuilder.isParallelTxProcessingEnabled(
          subStorageConfiguration.getUnstable().isParallelTxProcessingEnabled());
    }
    return idnControllerBuilder;
  }
    ...
    Runtime.getRuntime()
        .addShutdownHook(
            new Thread(
                () -> {
                  try {
                    idnPluginContext.stopPlugins();
                    runner.close();
                    LogConfigurator.shutdown();
                  } catch (final Exception e) {
                    logger.error("Failed to stop Idn");
                  }
                },
                "IdnCommand-Shutdown-Hook"));
  }
  ...
  /**
   * Returns data directory used by Idn. Visible as it is accessed by other subcommands.
   *
  ...
  /**
   * Metrics System used by Idn
   *
   * @return Instance of MetricsSystem
   */
  public MetricsSystem getMetricsSystem() {
    return idnComponent.getMetricsSystem();
  }
  ...
  /**
   * Idn CLI Parameters exception handler used by VertX. Visible for testing.
   *
   * @return instance of IdnParameterExceptionHandler
   */
  public IdnParameterExceptionHandler parameterExceptionHandler() {
    return new IdnParameterExceptionHandler(this::getLogLevel);
  }

  /**
   * Returns IdnExecutionExceptionHandler. Visible as it is used in testing.
   *
   * @return instance of IdnExecutionExceptionHandler used by Vertx.
   */
  public IdnExecutionExceptionHandler executionExceptionHandler() {
    return new IdnExecutionExceptionHandler();
  }
  ...
  private String generateConfigurationOverview() {
    ...
    builder.setPluginContext(this.idnPluginContext);
   ...
   */
  public IdnPluginContextImpl getIdnPluginContext() {
