 ...
 */
package org.idnecology.idn.nat;
...
public class NatService {
  ...
  /**
   * Returns whether or not the Idn node is running under a NAT environment.
   *
   * @return true if Idn node is running under NAT environment, false otherwise.
   */
