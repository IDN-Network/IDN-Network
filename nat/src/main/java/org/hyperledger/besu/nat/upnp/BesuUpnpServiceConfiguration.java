 ...
 */
package org.idnecology.idn.nat.upnp;
...
class IdnUpnpServiceConfiguration implements UpnpServiceConfiguration {
  private static final Logger LOG = LoggerFactory.getLogger(IdnUpnpServiceConfiguration.class);
