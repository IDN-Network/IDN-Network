...
public interface BlockInterface {
   ...
   */
  Address getProposerOfBlock(final org.idnecology.idn.ethereum.core.BlockHeader header);
   ...
   * @return the proposer of block
   */
  Address getProposerOfBlock(final org.idnecology.idn.plugin.data.BlockHeader header);
