...
import org.idnecology.idn.consensus.qbft.core.types.QbftValidatorModeTransitionLogger;
...
public class QbftValidatorModeTransitionLoggerAdaptor implements QbftValidatorModeTransitionLogger {
  ...
  public void logTransitionChange(final QbftBlockHeader parentHeader) {
    validatorModeTransitionLogger.logTransitionChange(BlockUtil.toIdnBlockHeader(parentHeader));
  }
}
