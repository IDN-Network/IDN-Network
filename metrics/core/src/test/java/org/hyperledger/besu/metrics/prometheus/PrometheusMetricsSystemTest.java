...
import static org.idnecology.idn.metrics.IdnMetricCategory.NETWORK;
import static org.idnecology.idn.metrics.IdnMetricCategory.PEERS;
import static org.idnecology.idn.metrics.IdnMetricCategory.RPC;
import static org.idnecology.idn.metrics.StandardMetricCategory.JVM;

import org.idnecology.idn.metrics.IdnMetricCategory;
import org.idnecology.idn.metrics.MetricsSystemFactory;
import org.idnecology.idn.metrics.ObservableMetricsSystem;
import org.idnecology.idn.metrics.Observation;
  ...
  public void shouldOnlyObserveEnabledMetrics() {
    final MetricsConfiguration metricsConfiguration =
        MetricsConfiguration.builder()
            .metricCategories(ImmutableSet.of(IdnMetricCategory.RPC))
            .enabled(true)
            .build();
