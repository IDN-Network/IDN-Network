...
import static org.idnecology.idn.metrics.prometheus.PrometheusCollector.getLabelValues;
...
/**
 * A Prometheus Guava cache collector implementation for Idn metrics. This class provides a way to
...
class PrometheusGuavaCache extends CategorizedPrometheusCollector {
   ...
   * that collector once when the first Idn Guava cache collector is created, and unregister it
