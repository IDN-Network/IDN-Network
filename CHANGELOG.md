...
- Other dependency updates [#8293](https://github.com/idnecology/idn/pull/8293) [#8315](https://github.com/idnecology/idn/pull/8315) [#8350](https://github.com/idnecology/idn/pull/8350)
...
- Support for enabling and configuring TLS/mTLS in WebSocket service. [#7854](https://github.com/idnecology/idn/pull/7854)
...
- Add `--ephemery` network support for Ephemery Testnet [#7563](https://github.com/idnecology/idn/pull/7563) thanks to [@gconnect](https://github.com/gconnect)
- Add configuration of Consolidation Request Contract Address via genesis configuration [#7647](https://github.com/idnecology/idn/pull/7647)
...
- Dedicated log marker for invalid txs removed from the txpool [#6826](https://github.com/idnecology/idn/pull/6826)
...
- Added configuration options for `pragueTime` to genesis file for Prague fork development [#6473](https://github.com/idnecology/idn/pull/6473)
...
- Bonsai TrieLog serialization interface and default implementation [#5372](https://github.com/idnecology/idn/pull/5372) 
...
- Idn requires minimum Java 17 and up to build and run [#3320](https://github.com/idnecology/idn/issues/3320)
...
- Change eth_feeHistory parameter `blockCount` to accept hexadecimal string (was accepting plain integer) [#5047](https://github.com/idnecology/idn/pull/5047)
- Default configurations for the deprecated Ropsten, Kiln, Shandong, and Astor networks have been removed from the CLI network list. These networks can currently be accessed but will require a user-provided genesis configuration. [#4869](https://github.com/idnecology/idn/pull/4869)
- GoQuorum-compatible privacy is deprecated and will be removed in 23.4
- IBFT 1.0 is deprecated and will be removed in 23.4
- Optimize SSTORE Operation execution time (memoize current and original value) [#4836](https://github.com/idnecology/idn/pull/4836)

### Additions and Improvements
- Default rpc batch request to 1024 [#5104](https://github.com/idnecology/idn/pull/5104) [#5108](https://github.com/idnecology/idn/pull/5108)
- Add a new CLI option to limit the number of requests in a single RPC batch request. [#4965](https://github.com/idnecology/idn/pull/4965)
- Support for new DATAHASH opcode as part of EIP-4844 [#4823](https://github.com/idnecology/idn/issues/4823)
- Send only hash announcement for blob transaction type [#4940](https://github.com/idnecology/idn/pull/4940)
- Add `excess_data_gas` field to block header [#4958](https://github.com/idnecology/idn/pull/4958)
- Add `max_fee_per_data_gas` field to transaction [#4970](https://github.com/idnecology/idn/pull/4970)
- Added option to evm CLI tool to allow code execution at specific forks [#4913](https://github.com/idnecology/idn/pull/4913)
- Improve get account performance by using the world state updater cache [#4897](https://github.com/idnecology/idn/pull/4897)
- Add new KZG precompile and option to override the trusted setup being used [#4822](https://github.com/idnecology/idn/issues/4822)
- Add implementation for eth_createAccessList RPC method [#4942](https://github.com/idnecology/idn/pull/4942)
- Updated reference tests to v11.3 [#4996](https://github.com/idnecology/idn/pull/4996)
- Add DebugGetRawBlock and DebugGetRawHeader RPC methods [#5011](https://github.com/idnecology/idn/pull/5011)
- Idn requires minimum Java 17 and up to build and run [#3320](https://github.com/idnecology/idn/issues/3320)
- Add worldstate auto-heal mechanism [#5059](https://github.com/idnecology/idn/pull/5059)
- Support for EIP-4895 - Withdrawals for Shanghai fork
- Improve SLOAD and SSTORE performance by caching empty slots [#4874](https://github.com/idnecology/idn/pull/4874)
- RPC methods that lookup block by hash will now return an error response if no block found [#4582](https://github.com/idnecology/idn/pull/4582)
- Added support for `safe` and `finalized` strings for the RPC methods using defaultBlock parameter [#4902](https://github.com/idnecology/idn/pull/4902)
- Added post-execution state logging option to EVM Tool [#4709](https://github.com/idnecology/idn/pull/4709)
- Add access list to Transaction Call Object [#4802](https://github.com/idnecology/idn/issues/4801)
- Add timestamp fork support, including shanghaiTime and cancunTime forks [#4743](https://github.com/idnecology/idn/pull/4743)
- Optimization:  Memoize transaction size and hash at the same time [#4812](https://github.com/idnecology/idn/pull/4812)
- Add chain data pruning feature with three experimental CLI options: `--Xchain-pruning-enabled`, `--Xchain-pruning-blocks-retained` and `--Xchain-pruning-frequency` [#4686](https://github.com/idnecology/idn/pull/4686)
...
### Bug Fixes
- Mitigation fix for stale bonsai code storage leading to log rolling issues on contract recreates [#4906](https://github.com/idnecology/idn/pull/4906)
- Ensure latest cached layered worldstate is subscribed to storage, fix problem with RPC calls using 'latest' [#5076](https://github.com/idnecology/idn/pull/5076)
- Fix for segmentation faults on worldstate truncation, snap-sync starts [#4786](https://github.com/idnecology/idn/pull/4786)
- Fix for worldstate mismatch on failed forkchoiceUpdate [#4862](https://github.com/idnecology/idn/pull/4862)

Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/23.1.0/idn-23.1.0.tar.gz / sha256: 9081da04d47c3ff0a6ecc2256d353c7a02212f9b46f2c867a9365e18026c3a6e
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/23.1.0/idn-23.1.0.zip / sha256: e037f5c8f976150af40403311d1c81018f4c3dfbef0ad33324d8c3e708d1fdca
...
### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/23.1.0-RC1/idn-23.1.0-RC1.tar.gz / sha256: 30906891e528b3b4e3ce8e2313550a1da066b31ea10b05456dd0ad026792b46d
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/23.1.0-RC1/idn-23.1.0-RC1.zip / sha256: 9067d1929079ae4a7c165e6f1e2bae08834939ed191f976d26544dc93352c306
...
### Breaking Changes
- Added `--rpc-max-logs-range` CLI option to allow limiting the number of blocks queried by `eth_getLogs` RPC API. Default value: 1000 [#4597](https://github.com/idnecology/idn/pull/4597)
...
### Additions and Improvements
- Implement Eth/68 sub-protocol [#4715](https://github.com/idnecology/idn/issues/4715)
- Increase the speed of modexp gas execution and execution. [#4780](https://github.com/idnecology/idn/pull/4780)
- Added experimental CLI options `--Xeth-capability-max` and `--Xeth-capability-min` to specify a range of capabilities to be supported by the Eth protocol. [#4752](https://github.com/idnecology/idn/pull/4752)
- Set the default curve in the EVMTool, like is done in production operations [#4790](https://github.com/idnecology/idn/pull/4790)

### Bug Fixes
- Fix storage key format for eth_getProof so that it follows the EIP-1474 spec [#4564](https://github.com/idnecology/idn/pull/4564)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.3/idn-22.10.3.tar.gz / sha256: 7213f9445a84a196e94ae1877c6fdb1e51d37bfb19615da02ef5121d4f40e38c
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.3/idn-22.10.3.zip / sha256: 0bf6bc98e01b0c1045f1b7d841a390c575bc5203c2a4e543d922fbc1ea0d3d5d

## 22.10.2
This is a hotfix release to resolve a race condition that results in segfaults, introduced in 22.10.1 release.

### Bug Fixes
- bugfix for async operations on Snapshot worldstates [#4767](https://github.com/idnecology/idn/pull/4767)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.2/idn-22.10.2.tar.gz  / sha256: cdb36141e3cba6379d35016e0a2de2edba579d4786124b5f7257b1e4a68867a2
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.2/idn-22.10.2.zip / sha256: 4c9208f684762670cb4f2c6ebfb6930e05e339a7c3c586fe8caa9f26462830aa


## 22.10.1

### Breaking Changes
- Fields `publicKey` and `raw` removed from RPC API `Transaction` result object [#4575](https://github.com/idnecology/idn/pull/4575)

### Additions and Improvements
- Explain and improve price validation for London and local transactions during block proposal selection [#4602](https://github.com/idnecology/idn/pull/4602)
- Support for ephemeral testnet Shandong, for EOF testing. [#4599](https://github.com/idnecology/idn/pull/4599)
- Improve performance of block processing by parallelizing some parts during the "commit" step [#4635](https://github.com/idnecology/idn/pull/4635)
- Upgrade RocksDB version from 7.6.0 to 7.7.3
- Added new RPC endpoints `debug_setHead` & `debug_replayBlock  [#4580](https://github.com/idnecology/idn/pull/4580)
- Upgrade OpenTelemetry to version 1.19.0 [#3675](https://github.com/idnecology/idn/pull/3675)
- Implement Eth/67 sub-protocol [#4596](https://github.com/idnecology/idn/issues/4596)
- Backward sync log UX improvements [#4655](https://github.com/idnecology/idn/pull/4655)
- Enable RocksDB Bloom filters to improve read performance [#4682](https://github.com/idnecology/idn/pull/4682)
- Backward sync: use retry switching peer when fetching data from peers [#4656](https://github.com/idnecology/idn/pull/4656)
- Shanghai implementation of EIP-3651 Warm coinbase [#4620](https://github.com/idnecology/idn/pull/4620) 
- Shanghai implementation of EIP-3855 Push0 [#4660](https://github.com/idnecology/idn/pull/4660)
- Shanghai implementation of EIP-3540 and EIP-3670 Ethereum Object Format and Code Validation [#4644](https://github.com/idnecology/idn/pull/4644)
- Remove some log statements that are keeping some objects live in heap for a long time, to reduce the amount of memory required during initial sync [#4705](https://github.com/idnecology/idn/pull/4705)
- Add field `type` to Transaction receipt object (eth_getTransactionReceipt) [#4505](https://github.com/idnecology/idn/issues/4505)
- Print an overview of configuration and system information at startup [#4451](https://github.com/idnecology/idn/pull/4451)
- Do not send new payloads to backward sync if initial sync is in progress [#4720](https://github.com/idnecology/idn/issues/4720)
- Improve the way transaction fee cap validation is done on London fee market to not depend on transient network conditions [#4598](https://github.com/idnecology/idn/pull/4598) 
- Preload and cache account and storage data from RocksDB to improve performance  [#4737](https://github.com/idnecology/idn/issues/4737)

### Bug Fixes
- Restore updating chain head and finalized block during backward sync [#4718](https://github.com/idnecology/idn/pull/4718)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.1/idn-22.10.1.tar.gz  / sha256: b6757b9fc69b782cdabb95b1e784d31b1effcc2e25c6b198b2f9d6b3786c7a8a
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.1/idn-22.10.1.zip / sha256: 0dbee534620c7cc0fac0596e6df0c7f8a74be9df9cecd9d4f1407016f30fb9a1

## 22.10.0

### Breaking Changes
- Internal and interface APIs relating to storage have migrated from `UInt256` to `Bytes32` [#4562](https://github.com/idnecology/idn/pull/4562)
- Flexible Privacy Groups (early access) support to Tessera's EC encryptor (contracts modified) [#4282](https://github.com/idnecology/idn/pull/4282)
...
- `--Xmerge-support` option removed (deprecated in 22.4.2) [#4518](https://github.com/idnecology/idn/pull/4518)
...
- Update snapsync feature to avoid restarting the download of the world state from scratch when restarting Idn [#4381](https://github.com/idnecology/idn/pull/4381)
- Added worldstate snapshot isolation to improve the stability of bonsai (`--Xbonsai-use-snapshots=true`) [#4351](https://github.com/idnecology/idn/pull/4531)
- Reduce the number of runtime exceptions (SecurityModuleException) and unnecessary executions during ECIES handshake, by trying to decrypt EIP-8 formatted messages first [#4508](https://github.com/idnecology/idn/pull/4508).
- Improved RLP processing of zero-length string as 0x80 [#4283](https://github.com/idnecology/idn/pull/4283) [#4388](https://github.com/idnecology/idn/issues/4388)
- Increased level of detail in JSON-RPC parameter error log messages [#4510](https://github.com/idnecology/idn/pull/4510)
- New unstable configuration options to set the maximum time, in milliseconds, a PoS block creation jobs is allowed to run [#4519](https://github.com/idnecology/idn/pull/4519)
- Tune EthScheduler thread pools to avoid recreating too many threads [#4529](https://github.com/idnecology/idn/pull/4529)
- RocksDB snapshot based worldstate and plugin-api addition of Snapshot interfaces [#4409](https://github.com/idnecology/idn/pull/4409)
- Continuously try to build better block proposals until timeout or GetPayload is called [#4516](https://github.com/idnecology/idn/pull/4516)
- Upgrade RocksDB database version from 6.29.5 to 7.6.0 [#4517](https://github.com/idnecology/idn/pull/4517)
- Avoid connecting to self when using static-nodes [#4521](https://github.com/idnecology/idn/pull/4521)
- EVM performance has increased 20%-100% depending on the particulars of the contract. [#4540](https://github.com/idnecology/idn/pull/4540)
- Improve calculateRootHash method performance during Block processing [#4568](https://github.com/idnecology/idn/pull/4568)
- Bring GraphQL into compliance with execution-api specs [#4112](https://github.com/idnecology/idn/pull/4112)
- Refactor unverified forkchoice event [#4487](https://github.com/idnecology/idn/pull/4487)
- Improve UX of initial sync logs, pushing not relevant logs to debug level [#4486](https://github.com/idnecology/idn/pull/4486)
- Optimize pivot block selector on PoS networks [#4488](https://github.com/idnecology/idn/pull/4488)
- Optimize Snap sync on PoS networks [#4462](https://github.com/idnecology/idn/pull/4462)

### Bug Fixes
- Fixed default fromBlock value and improved parameter interpretation in eth_getLogs RPC handler [#4513](https://github.com/idnecology/idn/pull/4513)
- Fix for NoSuchElementException for missing invalid reason when rejecting a local sent transaction [#4569](https://github.com/idnecology/idn/pull/4569)
- Corrects treating a block as bad on internal error during either validation or processing [#4512](https://github.com/idnecology/idn/issues/4512)
- Corrects emission of blockadded events when rewinding during a re-org. Fix for [#4495](https://github.com/idnecology/idn/issues/4495)
- Always return a transaction type for pending transactions [#4364](https://github.com/idnecology/idn/pull/4364)
- Avoid a cyclic reference while printing EngineExchangeTransitionConfigurationParameter [#4357](https://github.com/idnecology/idn/pull/4357)
- Corrects treating a block as bad on internal error [#4512](https://github.com/idnecology/idn/issues/4512)
- In GraphQL update scalar parsing to be variable friendly [#4522](https://github.com/idnecology/idn/pull/4522)
- Initiate connection to maintained peers soon after startup. [#4469](https://github.com/idnecology/idn/pull/4469)
- Update apache-commons-text to 1.10.0 to address CVE-2022-42889 [#4542](https://github.com/idnecology/idn/pull/4542)

### Download Links

https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.0/idn-22.10.0.tar.gz  / sha256: 88fb5df567e4ec3547d7d2970cfef00debbd020c0da66b19166d43779b3b2b85
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.10.0/idn-22.10.0.zip / sha256: c8e39f7c879409cb9b47f4d3de5e9c521249083830a8c9a45e8a14a319fe195d
...
- Flexible Privacy Groups (early access) support to Tessera's EC encryptor (contracts modified) [#4282](https://github.com/idnecology/idn/pull/4282)
  ...
  * For the EC encryptor, the encoded public key length is 91
- `--tx-pool-hashes-max-size` option removed (deprecated in 22.1.3)
- `--Xmerge-support` option remove (deprecated in 22.4.2) [#4518](https://github.com/idnecology/idn/pull/4518)
- Breaking API changes in the `OperationTracer` interface to enable performance work.
  * The `traceExecution` method has been replaced with `tracePreExecution` and `tracePostExecution` methods, called just before and just after operation execution. 
  * See `DebugOperationTracer` and `StandardJsonTracer` for migration examples.
...
- Improved RLP processing of zero-length string as 0x80 [#4283](https://github.com/idnecology/idn/pull/4283) [#4388](https://github.com/idnecology/idn/issues/4388)
- Increased level of detail in JSON-RPC parameter error log messages [#4510](https://github.com/idnecology/idn/pull/4510)
- New experimental configuration options to set the maximum time, in milliseconds, a PoS block creation jobs is allowed to run [#4519](https://github.com/idnecology/idn/pull/4519)
- Tune EthScheduler thread pools to avoid recreating too many threads [#4529](https://github.com/idnecology/idn/pull/4529)
- RocksDB snapshot based worldstate and plugin-api addition of Snapshot interfaces [#4409](https://github.com/idnecology/idn/pull/4409)
- Continuously try to build better block proposals until timeout or GetPayload is called [#4516](https://github.com/idnecology/idn/pull/4516)
- Upgrade RocksDB database version from 6.29.5 to 7.6.0 [#4517](https://github.com/idnecology/idn/pull/4517)
...
### Download Links
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.10.0-RC1/idn-22.10.0-RC1.zip / sha256: 16fd47533aa2986491143e5f4a052c0aa4866ebfa415abbf3ca868e4fbeac6ce
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.10.0-RC1/idn-22.10.0-RC1.tar.gz / sha256: 48fd3480e4380580ed9187302be987e9eca2b445935ec6a509e7269898d8a4a8

## 22.7.7

### Additions and Improvements
- Tune EthScheduler thread pools to avoid recreating too many threads [#4529](https://github.com/idnecology/idn/issues/4529)
- Reduce the number of runtime exceptions (SecurityModuleException) and unnecessary executions during ECIES handshake, by trying to decrypt EIP-8 formatted messages first [#4508](https://github.com/idnecology/idn/pull/4508).
- The block variable was keeping too much memory while waiting for future to finish [#4489](https://github.com/idnecology/idn/issues/4489)

### Bug Fixes
- Corrects treating a block as bad on internal error [#4512](https://github.com/idnecology/idn/issues/4512)
- update appache-commons-text to 1.10.0 to address CVE-2022-42889 [#4542](https://github.com/idnecology/idn/pull/4542)
- In GraphQL update scalar parsing to be variable friendly [#4522](https://github.com/idnecology/idn/pull/4522)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.7/idn-22.7.7.zip / sha256: 79b2b1518605603d8268f873f2576617ca8340d89c045e0eda6896f40defea0d
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.7/idn-22.7.7.tar.gz / sha256: 161c52ba9be8508767e80dbce796b4ad2cc5b649f7ed15387c6359d1e15753f6

## 22.7.6
Hotfix release of the 22.7.x series to address [#4495](https://github.com/idnecology/idn/issues/4495) which could result in failed block proposals on merge networks.

### Additions and Improvements
- Bring GraphQL into compliance with execution-api specs [#4112](https://github.com/idnecology/idn/pull/4112)

### Bug Fixes
- Corrects emission of blockadded events when rewinding during a re-org. [#4497](https://github.com/idnecology/idn/issues/4497)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.6/idn-22.7.6.zip / sha256: ae05040027b96ba458a08cfee8577dafe1d85a3afce793f00f798cedb3ab547d
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.6/idn-22.7.6.tar.gz / sha256: 9e538852f16fd39b884c4c342beaad813e33ab24890634c01eee3d37dc1da893

## 22.7.5

### Additions and Improvements
- Avoid sending added block events to transaction pool, and processing incoming transactions during initial sync [#4457](https://github.com/idnecology/idn/pull/4457)
- When building a new proposal, keep the best block built until now instead of the last one [#4455](https://github.com/idnecology/idn/pull/4455)
- Add Mainnet to merged networks [#4463](https://github.com/idnecology/idn/pull/4463)

### Bug Fixes
- Fixed logIndex value returned by eth_getLogs RPC call [#4355](https://github.com/idnecology/idn/pull/4355)

### Download Links
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.5/idn-22.7.5.zip / sha256: b5d7b255b249beea0f46ec397122823c75f2373083a71a9f7b4c98b2b0f94997
https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.5/idn-22.7.5.tar.gz / sha256: 91e3cbc16c46c53f7bf55bdd968553d0fb4087bff1e244cb03ac175ac54cf718


## 22.7.4

### Bug Fixes
- Remove records that track transactions by sender when they are empty to same memory in the transaction pool [#4415](https://github.com/idnecology/idn/pull/4415)
- Add Toml configuration file support for _--Xplugin-rocksdb-high-spec-enabled_ flag [#4438](https://github.com/idnecology/idn/pull/4438)

### Download Links
- https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.4/idn-22.7.4.zip / sha256: 4f2a0c20bee7f266ec1dcb45fa90ae1ca42f4b22e9b21a601b7705357259aea9
- https://idnecology.jfrog.io/idnecology/idn-binaries/idn/22.7.4/idn-22.7.4.tar.gz / sha256: a60efc4d515ac94710bbc6d61a24f409b03fcfc02323bee2a2d75c883fc99dce

## 22.7.3

### Additions and Improvements
- Allow free gas networks in the London fee market [#4061](https://github.com/idnecology/idn/issues/4061)
- Upgrade idn-native to 0.6.0 and use Blake2bf native implementation if available by default [#4264](https://github.com/idnecology/idn/pull/4264)
- Resets engine QoS timer with every call to the engine API instead of only when ExchangeTransitionConfiguration is called [#4411](https://github.com/idnecology/idn/issues/4411)
- ExchangeTransitionConfiguration mismatch will only submit a debug log not a warning anymore [#4411](https://github.com/idnecology/idn/issues/4411)
- Upgrade idn-native to 0.6.1 and include linux arm64 build of bls12-381 [#4416](https://github.com/idnecology/idn/pull/4416)
- Create a new flag on RocksDB (_--Xplugin-rocksdb-high-spec-enabled_) for high spec hardware to boost performance
- Transaction pool improvements to avoid filling the pool with not executable transactions, that could result in empty or semi-empty block proposals [#4425](https://github.com/idnecology/idn/pull/4425)
- Limit Transaction pool consumption by sender to a configurable percentage of the pool size [#4417](https://github.com/idnecology/idn/pull/4417)

### Bug Fixes
- Retry block creation if there is a transient error and we still have time, to mitigate empty block issue [#4407](https://github.com/idnecology/idn/pull/4407)
- Fix StacklessClosedChannelException in Idn and resulted timeout errors in CL clients ([#4398](https://github.com/idnecology/idn/issues/4398), [#4400](https://github.com/idnecology/idn/issues/4400))
- Return JSON-RPC error code instead of INVALID in engine api when certain storage exceptions are encountered ([#4349](https://github.com/idnecology/idn/issues/4349))

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.3/idn-22.7.3.tar.gz / sha256: `b0863fe2406cab57caf8a02f2bf02632cc5198622ac48b69bc63c128703bbd79`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.3/idn-22.7.3.zip / sha256: `368c6cb86119f8fe30bb12ab8c63b4d95a0fd8baf9c9414307a0a4033756b709`
...
### Additions and Improvements
- Better management of jemalloc presence/absence in startup script [#4237](https://github.com/idnecology/idn/pull/4237)
- Retry mechanism when getting a broadcasted block fail on all peers [#4271](https://github.com/idnecology/idn/pull/4271)
- Filter out disconnected peers when fetching available peers [#4269](https://github.com/idnecology/idn/pull/4269)
- Updated the default value of fast-sync-min-peers post merge [#4298](https://github.com/idnecology/idn/pull/4298)
- Log imported block info post merge [#4310](https://github.com/idnecology/idn/pull/4310)
- Transaction pool eviction by sender from tail of transaction list [#4327](https://github.com/idnecology/idn/pull/4327)
- Transaction pool sender future nonce limits [#4336](https://github.com/idnecology/idn/pull/4336)
...
### Bug Fixes
- Accept wit/80 from Nethermind [#4279](https://github.com/idnecology/idn/pull/4279)
- Properly shutdown the miner executor, to avoid waiting 30 seconds when stopping [#4353](https://github.com/idnecology/idn/pull/4353)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.2/idn-22.7.2.tar.gz / sha256: `8030a48f824c7bbc138b38a9e84e5531950bc16f6d21cda8b215232cce334214`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.2/idn-22.7.2.zip / sha256: `72653171b1ddd910e705fc6f616d7f1f4c120ef0d91718f0376f3ee5f2982c11`


## 22.7.1
### Merge Ready Release. Required update for The Merge on ethereum mainnet!
### Additions and Improvements
- Introduce a cap to reputation score increase [#4230](https://github.com/idnecology/idn/pull/4230)
- Add experimental CLI option for `--Xp2p-peer-lower-bound` [#4200](https://github.com/idnecology/idn/pull/4200)
- Improve pending blocks retrieval mechanism [#4227](https://github.com/idnecology/idn/pull/4227)
- Set mainnet terminal total difficulty [#4260](https://github.com/idnecology/idn/pull/4260)

### Bug Fixes
- Fixes off-by-one error for mainnet TTD fallback [#4223](https://github.com/idnecology/idn/pull/4223)
- Fix off-by-one error in AbstractRetryingPeerTask [#4254](https://github.com/idnecology/idn/pull/4254)
- Refactor and fix retrying get block switching peer [#4256](https://github.com/idnecology/idn/pull/4256)
- Fix encoding of key (short hex) in eth_getProof [#4261](https://github.com/idnecology/idn/pull/4261)
- Fix for post-merge networks fast-sync [#4224](https://github.com/idnecology/idn/pull/4224), [#4276](https://github.com/idnecology/idn/pull/4276)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.1/idn-22.7.1.tar.gz / sha256: `7cca4c11e1d7525c172f2af9fbf456d134ada60e970d8b6abcfcd6c623b5dd36`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.1/idn-22.7.1.zip / sha256: `ba6e0b9b65ac36d041a5072392f119ff76e8e9f53a3d7b1e1a658ef1e4705d7a`
...
### Additions and Improvements
- Deprecation warning for Ropsten, Rinkeby, Kiln [#4173](https://github.com/idnecology/idn/pull/4173)

### Bug Fixes

- Fixes previous known issue [#3890](https://github.com/idnecology/idn/issues/3890)from RC3 requiring a restart post-merge to continue correct transaction handling.
- Stop producing stack traces when a get headers response only contains the range start header [#4189](https://github.com/idnecology/idn/pull/4189)
- Upgrade Spotless to 6.8.0 [#4195](https://github.com/idnecology/idn/pull/4195)
- Upgrade Gradle to 7.5 [#4196](https://github.com/idnecology/idn/pull/4196)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0/idn-22.7.0.tar.gz / sha256: `af21104a880c37706b660aa816e1c38b2b3f603a97420ddcbc889324b71aa50e`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0/idn-22.7.0.zip / sha256: `5b1586362e6e739c206c25224bb753a372bad70c0b22dbe091f9253024ebdc45`

## 22.7.0-RC3

### Known/Outstanding issues:
- Idn requires a restart post-merge to re-enable remote transaction processing [#3890](https://github.com/idnecology/idn/issues/3890)

### Additions and Improvements
- Engine API: Change expiration time for JWT tokens to 60s [#4168](https://github.com/idnecology/idn/pull/4168)
- Sepolia mergeNetSplit block [#4158](https://github.com/idnecology/idn/pull/4158)
- Goerli TTD [#4160](https://github.com/idnecology/idn/pull/4160)
- Several logging improvements

### Bug Fixes
- Allow to set any value for baseFeePerGas in the genesis file [#4177](https://github.com/idnecology/idn/pull/4177)
- Fix for stack overflow when searching for TTD block [#4169](https://github.com/idnecology/idn/pull/4169)
- Fix for chain stuck issue [#4175](https://github.com/idnecology/idn/pull/4175)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC3/idn-22.7.0-RC3.tar.gz / sha256: `6a1ee89c82db9fa782d34733d8a8c726670378bcb71befe013da48d7928490a6`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC3/idn-22.7.0-RC3.zip / sha256: `5de22445ab2a270cf33e1850cd28f1946442b7104738f0d1ac253a009c53414e`

## 22.7.0-RC2

### Additions and Improvements
- Add a block to the bad blocks if it did not descend from the terminal block [#4080](https://github.com/idnecology/idn/pull/4080)
- Backward sync exception improvements [#4092](https://github.com/idnecology/idn/pull/4092)
- Remove block header checks during backward sync, since they will be always performed during block import phase [#4098](https://github.com/idnecology/idn/pull/4098)
- Optimize the backward sync retry strategy [#4095](https://github.com/idnecology/idn/pull/4095)
- Add support for jemalloc library to better handle rocksdb memory consumption [#4126](https://github.com/idnecology/idn/pull/4126)
- RocksDB configuration changes to improve performance. [#4132](https://github.com/idnecology/idn/pull/4132)

### Bug Fixes
- Changed max message size in the p2p layer to 16.7MB from 10MB to improve peering performance [#4120](https://github.com/idnecology/idn/pull/4120)
- Fixes for parent stateroot mismatch when using Bonsai storage mode (please report if you encounter this bug on this version) [#4094](https://github.com/idnecology/idn/pull/4094)
- Above Bonsai related fixes have addressed situations where the event log was not indexed properly [#3921](https://github.com/idnecology/idn/pull/3921)
- Fixes related to backward sync and reorgs [#4097](https://github.com/idnecology/idn/pull/4097)
- Checkpoint sync with more merge friendly checkpoint blocks [#4085](https://github.com/idnecology/idn/pull/4085)
- Fixes around RocksDB performance and memory usage [#4128](https://github.com/idnecology/idn/pull/4128)
- Fix for RPC performance parallelization to improve RPC performance under heavy load [#3959](https://github.com/idnecology/idn/pull/3959)
- Fix for post-Merge peering after PoW is removed in our logic for weighting peers [#4116](https://github.com/idnecology/idn/pull/4116)
- Various logging changes to improve UX- Return the correct latest valid hash in case of bad block when calling engine methods [#4056](https://github.com/idnecology/idn/pull/4056)
- Add a PoS block header rule to check that the current block is more recent than its parent [#4066](https://github.com/idnecology/idn/pull/4066)
- Fixed a trie log layer issue on bonsai during reorg [#4069](https://github.com/idnecology/idn/pull/4069)
- Fix transition protocol schedule to return the pre Merge schedule when reorg pre TTD [#4078](https://github.com/idnecology/idn/pull/4078)
- Remove hash to sync from the queue only if the sync step succeeds [#4105](https://github.com/idnecology/idn/pull/4105)
- The build process runs successfully even though the system language is not English [#4102](https://github.com/idnecology/idn/pull/4102)
- Avoid starting or stopping the BlockPropagationManager more than once [#4122](https://github.com/idnecology/idn/pull/4122)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC2/idn-22.7.0-RC2.tar.gz / sha256: `befe15b893820c9c6451a74fd87b41f555ff28561494b3bebadd5da5c7ce25d3`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC2/idn-22.7.0-RC2.zip / sha256: `d56c340f5982b882fbecca2697ca72a5bbefe0e978d2d4504211f012e2242a81`

## 22.7.0-RC1

### Additions and Improvements
- Do not require a minimum block height when downloading headers or blocks [#3911](https://github.com/idnecology/idn/pull/3911)
- When on PoS the head can be only be updated by ForkchoiceUpdate [#3994](https://github.com/idnecology/idn/pull/3994)
- Version information available in metrics [#3997](https://github.com/idnecology/idn/pull/3997)
- Add TTD and DNS to Sepolia config [#4024](https://github.com/idnecology/idn/pull/4024)
- Return `type` with value `0x0` when serializing legacy transactions [#4027](https://github.com/idnecology/idn/pull/4027)
- Ignore `ForkchoiceUpdate` if `newHead` is an ancestor of the chain head [#4055](https://github.com/idnecology/idn/pull/4055)

### Bug Fixes
- Fixed a snapsync issue that can sometimes block the healing step [#3920](https://github.com/idnecology/idn/pull/3920)
- Support free gas networks in the London fee market [#4003](https://github.com/idnecology/idn/pull/4003)
- Limit the size of outgoing eth subprotocol messages.  [#4034](https://github.com/idnecology/idn/pull/4034)
- Fixed a state root mismatch issue on bonsai that may appear occasionally [#4041](https://github.com/idnecology/idn/pull/4041)

### Download links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC1/idn-22.7.0-RC1.tar.gz / sha256: `60ad8b53402beb62c24ad791799d9cfe444623a58f6f6cf1d0728459cb641e63`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.7.0-RC1/idn-22.7.0-RC1.zip / sha256: `7acfb3a73382bf70f6337e83cb7e9e472b4e5a9da88c5ed2fbd9e82fcf2046dc`

## 22.4.3

### Additions and Improvements
- \[EXPERIMENTAL\] Add checkpoint sync `--sync-mode="X_CHECKPOINT"` [#3849](https://github.com/idnecology/idn/pull/3849)
- Support `finalized` and `safe` as tags for the block parameter in RPC APIs [#3950](https://github.com/idnecology/idn/pull/3950)
- Added verification of payload attributes in ForkchoiceUpdated [#3837](https://github.com/idnecology/idn/pull/3837)
- Add support for Gray Glacier hardfork [#3961](https://github.com/idnecology/idn/issues/3961)

### Bug Fixes
- alias engine-rpc-port parameter with the former rpc param name [#3958](https://github.com/idnecology/idn/pull/3958)

## 22.4.2

### Additions and Improvements
- Engine API Update: Replace deprecated INVALID_TERMINAL_BLOCK with INVALID last valid hash 0x0 [#3882](https://github.com/idnecology/idn/pull/3882)
- Deprecate experimental merge flag and engine-rpc-enabled flag [#3875](https://github.com/idnecology/idn/pull/3875)
- Update idn-native dependencies to 0.5.0 for linux arm64 support
- Update ropsten TTD to 100000000000000000000000

### Bug Fixes
- Stop backward sync if genesis block has been reached [#3869](https://github.com/idnecology/idn/pull/3869)
- Allow to backward sync to request headers back to last finalized block if present or genesis [#3888](https://github.com/idnecology/idn/pull/3888)

### Download link
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.2/idn-22.4.2.zip / sha256: `e8e9eb7e3f544ecefeec863712fb8d3f6a569c9d70825a4ed2581c596db8fd45`
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.2/idn-22.4.2.tar.gz / sha256: `9db0c37440cb56bcf671b8de13e0ecb6235171a497bdad91020b8c4a9dac2a27`

## 22.4.1

### Additions and Improvements
- GraphQL - allow null log topics in queries which match any topic [#3662](https://github.com/idnecology/idn/pull/3662)
- multi-arch docker builds for amd64 and arm64 [#2954](https://github.com/idnecology/idn/pull/2954)
- Filter Netty native lib errors likewise the pure Java implementation [#3807](https://github.com/idnecology/idn/pull/3807)
- Add ropsten terminal total difficulty config [#3871](https://github.com/idnecology/idn/pull/3871)

### Bug Fixes
- Stop the BlockPropagationManager when it receives the TTD reached event [#3809](https://github.com/idnecology/idn/pull/3809)
- Correct getMixHashOrPrevRandao to return the value present in the block header [#3839](https://github.com/idnecology/idn/pull/3839)

## 22.4.0

### Breaking Changes
- Version 22.4.x will be the last series to support Java 11. Version 22.7.0 will require Java 17 to build and run.
- In the Idn EVM Library all references to SHA3 have been renamed to the more accurate name Keccak256, including class names and comment. [#3749](https://github.com/idnecology/idn/pull/3749)
- Removed the Gas object and replaced it with a primitive long [#3674](https://github.com/idnecology/idn/pull/3674)
- Column family added for backward sync [#3638](https://github.com/idnecology/idn/pull/3638)
...
### Bug Fixes
- Fix nullpointer on snapsync [#3773](https://github.com/idnecology/idn/pull/3773)
- Introduce RocksDbSegmentIdentifier to avoid changing the storage plugin [#3755](https://github.com/idnecology/idn/pull/3755)

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0/idn-22.4.0.zip / SHA256 d89e102a1941e70be31c176a6dd65cd5f3d69c4c
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0/idn-22.4.0.tar.gz / SHA256 868e38749dd40debe028624f8267f1fce7587010

## 22.4.0-RC2

### Breaking Changes
- In the Idn EVM Library all references to SHA3 have been renamed to the more accurate name Kecack256, including class names and comment. [#3749](https://github.com/idnecology/idn/pull/3749)

### Additions and Improvements
- Onchain node permissioning
  - Log the enodeURL that was previously only throwing an IllegalStateException during the isPermitted check [#3697](https://github.com/idnecology/idn/pull/3697),
  - Fail startup if node permissioning smart contract version does not match [#3765](https://github.com/idnecology/idn/pull/3765)
- \[EXPERIMENTAL\] Add snapsync `--sync-mode="X_SNAP"` (only as client) [#3710](https://github.com/idnecology/idn/pull/3710)
- Adapt Fast sync, and Snap sync, to use finalized block, from consensus layer, as pivot after the Merge [#3506](https://github.com/idnecology/idn/issues/3506)
- Add IPC JSON-RPC interface (BSD/MacOS and Linux only) [#3695](https://github.com/idnecology/idn/pull/3695)
- Column family added for backward sync [#3638](https://github.com/idnecology/idn/pull/3638)
  - Note that this added column family makes this a one-way upgrade. That is, once you upgrade your db to this version, you cannot roll back to a previous version of Idn.

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0-RC2/idn-22.4.0-RC2.zip /  SHA256 5fa7f927c6717ebf503291c058815cd0c5fcfab13245d3b6beb66eb20cf7ac24
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0-RC2/idn-22.4.0-RC2.tar.gz / SHA256 1c4ecd17552cf5ebf120fc35dad753f45cb951ea0f817381feb2477ec0fff9c9

## 22.4.0-RC1

### Additions and Improvements
- Unit tests are now executed with JUnit5 [#3620](https://github.com/idnecology/idn/pull/3620)
- Removed the Gas object and replaced it with a primitive long [#3674]

### Bug Fixes
- Flexible Privacy Precompile handles null payload ID [#3664](https://github.com/idnecology/idn/pull/3664)
- Subcommand blocks import throws exception [#3646](https://github.com/idnecology/idn/pull/3646)

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0-RC1/idn-22.4.0-RC1.zip / SHA256 0779082acc20a98eb810eb08778e0c0e1431046c07bc89019a2761fd1baa4c25
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.4.0-RC1/idn-22.4.0-RC1.tar.gz / SHA256 15d8b0e335f962f95da46864109db9f28ed4f7bc351995b2b8db477c12b94860

## 22.1.3

### Breaking Changes
- Remove the experimental flag for bonsai tries CLI options `--data-storage-format` and `--bonsai-maximum-back-layers-to-load` [#3578](https://github.com/idnecology/idn/pull/3578)
- Column family added for backward sync [#3532](https://github.com/idnecology/idn/pull/3532)
  - Note that this added column family makes this a one-way upgrade. That is, once you upgrade your db to this version, you cannot roll back to a previous version of Idn.
...
### Additions and Improvements
- Tune transaction synchronization parameter to adapt to mainnet traffic [#3610](https://github.com/idnecology/idn/pull/3610)
- Improve eth/66 support [#3616](https://github.com/idnecology/idn/pull/3616)
- Avoid reprocessing remote transactions already seen [#3626](https://github.com/idnecology/idn/pull/3626)
- Upgraded jackson-databind dependency version [#3647](https://github.com/idnecology/idn/pull/3647)

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.3/idn-22.1.3.zip /  SHA256 9dafb80f2ec9ce8d732fd9e9894ca2455dd02418971c89cd6ccee94c53354d5d
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.3/idn-22.1.3.tar.gz / SHA256 f9f8d37353aa4b5d12e87c08dd86328c1cffc591c6fc9e076c0f85a1d4663dfe

## 22.1.2

### Additions and Improvements
- Execution layer (The Merge):
  - Execution specific RPC endpoint [#3378](https://github.com/idnecology/idn/issues/3378)
...
- Allow mining beneficiary to transition at specific blocks for ibft2 and qbft consensus mechanisms.  [#3115](https://github.com/idnecology/idn/issues/3115)
- Return richer information from the PrecompiledContract interface. [\#3546](https://github.com/idnecology/idn/pull/3546)

### Bug Fixes
- Reject locally-sourced transactions below the minimum gas price when not mining. [#3397](https://github.com/idnecology/idn/pull/3397)
- Fixed bug with contract address supplied to `debug_accountAt` [#3518](https://github.com/idnecology/idn/pull/3518)

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.2/idn-22.1.2.zip /  SHA256 1b26e3f8982c3a9dbabc72171f83f1cfe89eef84ead45b184ee9101f411c1251
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.2/idn-22.1.2.tar.gz / SHA256 1eca9abddf351eaaf4e6eaa1b9536b8b4fd7d30a81d39f9d44ffeb198627ee7a

## 22.1.1

### Additions and Improvements
- Allow optional RPC methods that bypass authentication [#3382](https://github.com/idnecology/idn/pull/3382)
- Execution layer (The Merge):
  - Extend block creation and mining to support The Merge [#3412](https://github.com/idnecology/idn/pull/3412)
  - Backward sync [#3410](https://github.com/idnecology/idn/pull/3410)
  - Extend validateAndProcessBlock to return an error message in case of failure, so it can be returned to the caller of ExecutePayload API [#3411](https://github.com/idnecology/idn/pull/3411)
  - Persist latest finalized block [#2913](https://github.com/idnecology/idn/issues/2913)
  - Add PostMergeContext, and stop syncing after the switch to PoS [#3453](https://github.com/idnecology/idn/pull/3453)
  - Add header validation rules needed to validate The Merge blocks [#3454](https://github.com/idnecology/idn/pull/3454)
  - Add core components: controller builder, protocol scheduler, coordinator, block creator and processor. [#3461](https://github.com/idnecology/idn/pull/3461)
  - Execution specific RPC endpoint [#2914](https://github.com/idnecology/idn/issues/2914), [#3350](https://github.com/idnecology/idn/pull/3350)
- QBFT consensus algorithm is production ready

## Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.1/idn-22.1.1.zip /  SHA256 cfff79e19e5f9a184d0b62886990698b77d019a0745ea63b5f9373870518173e
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.1/idn-22.1.1.tar.gz / SHA256 51cc9d35215f977ac7338e5c611c60f225fd6a8c1c26f188e661624a039e83f3

## 22.1.0

### Breaking Changes
- Plugin API: BlockHeader.getBaseFee() method now returns an optional Wei instead of an optional Long [#3065](https://github.com/idnecology/idn/issues/3065)
- Removed deprecated hash variable `protected volatile Hash hash;` which was used for private transactions [#3110](https://github.com/idnecology/idn/pull/3110)

### Additions and Improvements
- Add support for additional JWT authentication algorithms [#3017](https://github.com/idnecology/idn/pull/3017)
- Represent baseFee as Wei instead of long accordingly to the spec [#2785](https://github.com/idnecology/idn/issues/2785)
- Implements [EIP-4399](https://eips.ethereum.org/EIPS/eip-4399) to repurpose DIFFICULTY opcode after the merge as a source of entropy from the Beacon chain. [#3081](https://github.com/idnecology/idn/issues/3081)
- Re-order external services (e.g JsonRpcHttpService) to start before blocks start processing [#3118](https://github.com/idnecology/idn/pull/3118)
- Stream JSON RPC responses to avoid creating big JSON strings in memory [#3076](https://github.com/idnecology/idn/pull/3076)
- Ethereum Classic Mystique Hard Fork [#3256](https://github.com/idnecology/idn/pull/3256)
- Genesis file parameter `blockperiodseconds` is validated as a positive integer on startup to prevent unexpected runtime behaviour [#3186](https://github.com/idnecology/idn/pull/3186)
- Add option to require replay protection for locally submitted transactions [\#1975](https://github.com/idnecology/idn/issues/1975)
- Update to block header validation for IBFT and QBFT to support London fork EIP-1559 [#3251](https://github.com/idnecology/idn/pull/3251)
- Move into SLF4J as logging facade [#3285](https://github.com/idnecology/idn/pull/3285)
- Changing the order in which we traverse the word state tree during fast sync. This should improve fast sync during subsequent pivot changes.[#3202](https://github.com/idnecology/idn/pull/3202)
- Updated idn-native to version 0.4.3 [#3331](https://github.com/idnecology/idn/pull/3331)
- Refactor synchronizer to asynchronously retrieve blocks from peers, and to change peer when retrying to get a block. [#3326](https://github.com/idnecology/idn/pull/3326)
- Disable RocksDB TTL compactions [#3356](https://github.com/idnecology/idn/pull/3356)
- add a websocket frame size configuration CLI parameter [#3386](https://github.com/idnecology/idn/pull/3386)
- Add `--ec-curve` parameter to export/export-address public-key subcommands [#3333](https://github.com/idnecology/idn/pull/3333)

### Bug Fixes
- Change the base docker image from Debian Buster to Ubuntu 20.04 [#3171](https://github.com/idnecology/idn/issues/3171) fixes [#3045](https://github.com/idnecology/idn/issues/3045)
- Make 'to' field optional in eth_call method according to the spec [#3177](https://github.com/idnecology/idn/pull/3177)
...
- Fix a sync issue, when the chain downloader incorrectly shutdown when a task in the pipeline is cancelled. [#3319](https://github.com/idnecology/idn/pull/3319)
- add a websocket frame size configuration CLI parameter [3368][https://github.com/idnecology/idn/pull/3379]
- Prevent node from peering to itself [#3342](https://github.com/idnecology/idn/pull/3342)
- Fix an `IndexOutOfBoundsException` exception when getting block from peers. [#3304](https://github.com/idnecology/idn/issues/3304)
- Handle legacy eth64 without throwing null pointer exceptions [#3343](https://github.com/idnecology/idn/pull/3343)

### Download Links
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.0/idn-22.1.0.tar.gz \ SHA256 232bd7f274691ca14c26289fdc289d3fcdf69426dd96e2fa1601f4d079645c2f
- https://idnecology.jfrog.io/artifactory/idn-binaries/idn/22.1.0/idn-22.1.0.zip \ SHA256 1b701ff5b647b64aff3d73d6f1fe3fdf73f14adbe31504011eff1660ab56ad2b
 ...
 **Full Changelog**: https://github.com/idnecology/idn/compare/21.10.8...21.10.9

[idn-21.10.9.tar.gz](https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.9/idn-21.10.9.tar.gz) a4b85ba72ee73017303e4b2f0fdde84a87d376c2c17fdcebfa4e34680f52fc71
[idn-21.10.9.zip](https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.9/idn-21.10.9.zip) c3ba3f07340fa80064ba7c06f2c0ec081184e000f9a925d132084352d0665ef9
...
### Download Links
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.8/idn-21.10.8.tar.gz \ SHA256 d325e2e36bc38a707a9eebf92068f5021606a8c6b6464bb4b4d59008ef8014fc
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.8/idn-21.10.8.zip \ SHA256 a91da1e82fb378e16437327bba56dd299aafdb0614ba528167a1dae85440c5af
...
### Download Links
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.7/idn-21.10.7.tar.gz \ SHA256 94cee804fcaea366c9575380ef0e30ed04bf2fc7451190a94887f14c07f301ff
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.7/idn-21.10.7.zip \ SHA256 faf1ebfb20aa6171aa6ea98d7653339272567c318711d11e350471b5bba62c00
...
### Download Links
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.6/idn-21.10.6.tar.gz \ SHA256 ef579490031dd4eb3704b4041e352cfb2e7e787fcff7506b69ef88843d4e1220
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.6/idn-21.10.6.zip \ SHA256 0fdda65bc993905daa14824840724d0b74e3f16f771f5726f5307f6d9575a719
...
### Download Links
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.5/idn-21.10.5.tar.gz \ SHA256 0d1b6ed8f3e1325ad0d4acabad63c192385e6dcbefe40dc6b647e8ad106445a8
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.10.5/idn-21.10.5.zip \ SHA256 a1689a8a65c4c6f633b686983a6a1653e7ac86e742ad2ec6351176482d6e0c57
...
- Represent baseFee as Wei instead of long accordingly to the spec [#2785](https://github.com/idnecology/idn/issues/2785)
- Adding support of the NO_COLOR environment variable as described in the [NO_COLOR](https://no-color.org/) standard [#3085](https://github.com/idnecology/idn/pull/3085)
- Add `privx_findFlexiblePrivacyGroup` RPC Method, `privx_findOnchainPrivacyGroup` will be removed in a future release [#3075](https://github.com/idnecology/idn/pull/3075)
- The invalid value is now shown when `--bootnodes` cannot parse an item to make it easier to identify which option is invalid.
- Adding two new options to be able to specify desired TLS protocol version and Java cipher suites [#3105](https://github.com/idnecology/idn/pull/3105)
- Implements [EIP-4399](https://eips.ethereum.org/EIPS/eip-4399) to repurpose DIFFICULTY opcode after the merge as a source of entropy from the Beacon chain. [#3081](https://github.com/idnecology/idn/issues/3081)
...
### Additions and Improvements
- Add discovery options to genesis file [#2944](https://github.com/idnecology/idn/pull/2944)
- Add validate-config subcommand to perform basic syntax validation of TOML config [#2994](https://github.com/idnecology/idn/pull/2994)
- Updated Sepolia Nodes [#3034](https://github.com/idnecology/idn/pull/3034) [#3035](https://github.com/idnecology/idn/pull/3035)

### Bug Fixes
- Reduce shift calculations to shifts that may have an actual result. [#3039](https://github.com/idnecology/idn/pull/3039)
- DNS Discovery daemon wasn't started [#3033](https://github.com/idnecology/idn/pull/3033)
...
### Additions and Improvements
- Add CLI autocomplete scripts. [#2854](https://github.com/idnecology/idn/pull/2854)
- Add support for PKCS11 keystore on PKI Block Creation. [#2865](https://github.com/idnecology/idn/pull/2865)
- Optimize EVM Memory for MLOAD Operations [#2917](https://github.com/idnecology/idn/pull/2917)
- Upgrade CircleCI OpenJDK docker image to version 11.0.12. [#2928](https://github.com/idnecology/idn/pull/2928)
- Update JDK 11 to latest version in Idn Docker images. [#2925](https://github.com/idnecology/idn/pull/2925)
- Add Sepolia proof-of-work testnet configurations [#2920](https://github.com/idnecology/idn/pull/2920)
- Allow block period to be configured for IBFT2 and QBFT using transitions [#2902](https://github.com/idnecology/idn/pull/2902)
- Add support for binary messages (0x02) for websocket. [#2980](https://github.com/idnecology/idn/pull/2980)

### Bug Fixes
- Do not change the sender balance, but set gas fee to zero, when simulating a transaction without enforcing balance checks. [#2454](https://github.com/idnecology/idn/pull/2454)
- Ensure genesis block has the default base fee if london is at block 0 [#2920](https://github.com/idnecology/idn/pull/2920)
- Fixes the exit condition for loading a BonsaiPersistedWorldState for a sibling block of the last one persisted [#2967](https://github.com/idnecology/idn/pull/2967)

### Early Access Features
- Enable plugins to expose custom JSON-RPC / WebSocket methods [#1317](https://github.com/idnecology/idn/issues/1317)
...
### Additions and Improvements
- The EVM has been factored out into a standalone module, suitable for inclusion as a library. [#2790](https://github.com/idnecology/idn/pull/2790)
- Low level performance improvements changes to cut worst-case EVM performance in half. [#2796](https://github.com/idnecology/idn/pull/2796)
- Migrate `ExceptionalHaltReason` from an enum to an interface to allow downstream users of the EVM to add new exceptional halt reasons. [#2810](https://github.com/idnecology/idn/pull/2810)
- reduces need for JUMPDEST analysis via caching [#2607](https://github.com/idnecology/idn/pull/2821)
- Add support for custom private key file for public-key export and public-key export-address commands [#2801](https://github.com/idnecology/idn/pull/2801)
- Add CLI autocomplete scripts. [#2854](https://github.com/idnecology/idn/pull/2854)
- Added support for PKCS11 keystore on PKI Block Creation. [#2865](https://github.com/idnecology/idn/pull/2865)
- add support for ArrowGlacier hardfork [#2943](https://github.com/idnecology/idn/issues/2943)

### Bug Fixes
- Allow BESU_CONFIG_FILE environment to specify TOML file [#2455](https://github.com/idnecology/idn/issues/2455)
- Fix bug with private contracts not able to call public contracts that call public contracts [#2816](https://github.com/idnecology/idn/pull/2816)
- Fixes the exit condition for loading a BonsaiPersistedWorldState for a sibling block of the last one persisted [#2967](https://github.com/idnecology/idn/pull/2967)
- Fixes bonsai getMutable regression affecting fast-sync [#2934](https://github.com/idnecology/idn/pull/2934)
- Regression in RC1 involving LogOperation and frame memory overwrites [#2908](https://github.com/idnecology/idn/pull/2908)
- Allow `eth_call` and `eth_estimateGas` to accept contract address as sender. [#2891](https://github.com/idnecology/idn/pull/2891)
...
- Regression in RC1 involving LogOperation and frame memory overwrites [#2908](https://github.com/idnecology/idn/pull/2908)
- Allow `eth_call` and `eth_estimateGas` to accept contract address as sender. [#2891](https://github.com/idnecology/idn/pull/2891)
- Fix Concurrency issues in Ethpeers. [#2896](https://github.com/idnecology/idn/pull/2896)
...
## 21.7.4
### Additions and Improvements
- Upgrade Gradle to 7.2, which supports building with Java 17 [#2761](https://github.com/idnecology/idn/pull/2376)

### Bug Fixes
- Set an idle timeout for metrics connections, to clean up ports when no longer used [\#2748](https://github.com/idnecology/idn/pull/2748)
- Onchain privacy groups can be unlocked after being locked without having to add a participant [\#2693](https://github.com/idnecology/idn/pull/2693)
- Update Gas Schedule for Ethereum Classic [#2746](https://github.com/idnecology/idn/pull/2746)

### Early Access Features
- \[EXPERIMENTAL\] Added support for QBFT with PKI-backed Block Creation. [#2647](https://github.com/idnecology/idn/issues/2647)
- \[EXPERIMENTAL\] Added support for QBFT to use retrieve validators from a smart contract [#2574](https://github.com/idnecology/idn/pull/2574)

### Download Link
https://idnecology.jfrog.io/native/idn-binaries/idn/21.7.4/idn-21.7.4.zip \
SHA256: 778d3c42851db11fec9171f77b22662f2baeb9b2ce913d7cfaaf1042ec19b7f9

## 21.7.3
### Additions and Improvements
- Migration to Apache Tuweni 2.0 [\#2376](https://github.com/idnecology/idn/pull/2376)
- \[EXPERIMENTAL\] Added support for DevP2P-over-TLS [#2536](https://github.com/idnecology/idn/pull/2536)
- `eth_getWork`, `eth_submitWork` support over the Stratum port [#2581](https://github.com/idnecology/idn/pull/2581)
- Stratum metrics [#2583](https://github.com/idnecology/idn/pull/2583)
- Support for mining ommers [#2576](https://github.com/idnecology/idn/pull/2576)
- Updated onchain permissioning to validate permissions on transaction submission [\#2595](https://github.com/idnecology/idn/pull/2595)
- Removed deprecated CLI option `--privacy-precompiled-address` [#2605](https://github.com/idnecology/idn/pull/2605)
- Removed code supporting EIP-1702. [#2657](https://github.com/idnecology/idn/pull/2657)
- A native library was added for the alternative signature algorithm secp256r1, which will be used by default [#2630](https://github.com/idnecology/idn/pull/2630)
- The command line option --Xsecp-native-enabled was added as an alias for --Xsecp256k1-native-enabled [#2630](https://github.com/idnecology/idn/pull/2630)
- Added Labelled gauges for metrics [#2646](https://github.com/idnecology/idn/pull/2646)
- support for `eth/66` networking protocol [#2365](https://github.com/idnecology/idn/pull/2365)
- update RPC methods for post london 1559 transaction [#2535](https://github.com/idnecology/idn/pull/2535)
- \[EXPERIMENTAL\] Added support for using DNS host name in place of IP address in onchain node permissioning rules [#2667](https://github.com/idnecology/idn/pull/2667)
- Implement EIP-3607 Reject transactions from senders with deployed code. [#2676](https://github.com/idnecology/idn/pull/2676)
- Ignore all unknown fields when supplied to eth_estimateGas or eth_call. [\#2690](https://github.com/idnecology/idn/pull/2690)

### Bug Fixes
- Consider effective price and effective priority fee in transaction replacement rules [\#2529](https://github.com/idnecology/idn/issues/2529)
- GetTransactionCount should return the latest transaction count if it is greater than the transaction pool [\#2633](https://github.com/idnecology/idn/pull/2633)
...
## Bug Fixes
- hotfix for private transaction identification for mainnet transactions [#2609](https://github.com/idnecology/idn/pull/2609)

## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.7.2/idn-21.7.2.zip \
...
### Additions and Improvements
- `priv_call` now uses NO_TRACING OperationTracer implementation which improves memory usage [\#2482](https://github.com/idnecology/idn/pull/2482)
- Ping and Pong messages now support ENR encoding as scalars or bytes [\#2512](https://github.com/idnecology/idn/pull/2512)

### Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.7.1/idn-21.7.1.zip \
...
- eip-1559 changes: accept transactions which have maxFeePerGas below current baseFee [\#2374](https://github.com/idnecology/idn/pull/2374)
- Introduced transitions for IBFT2 block rewards [\#1977](https://github.com/idnecology/idn/pull/1977)
- Change Ethstats's status from experimental feature to stable. [\#2405](https://github.com/idnecology/idn/pull/2405)
- Fixed disabling of native libraries for secp256k1 and altBn128. [\#2163](https://github.com/idnecology/idn/pull/2163)
- eth_feeHistory API for wallet providers [\#2466](https://github.com/idnecology/idn/pull/2466)

### Bug Fixes
- Ibft2 could create invalid RoundChange messages in some circumstances containing duplicate prepares [\#2449](https://github.com/idnecology/idn/pull/2449)
- Updated `eth_sendRawTransaction` to return an error when maxPriorityFeePerGas exceeds maxFeePerGas [\#2424](https://github.com/idnecology/idn/pull/2424)
- Fixed NoSuchElementException with EIP1559 transaction receipts when using eth_getTransactionReceipt [\#2477](https://github.com/idnecology/idn/pull/2477)
...
### Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.7.0/idn-21.7.0.zip
...
## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.7.0-RC2/idn-21.7.0-RC2.zip
...
## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.7.0-RC1/idn-21.7.0-RC1.zip
sha256sum fc959646af65a0e267fc4d695e0af7e87331d774e6e8e890f5cc391549ed175a

## 21.1.7

## Privacy users - Orion Project Deprecation
Tessera is now the recommended Private Transaction Manager for Idn ecology Idn.
...
### Additions and Improvements
* Upgrade OpenTelemetry to 1.2.0. [\#2313](https://github.com/idnecology/idn/pull/2313)

* Ethereum Classic Magneto Hard Fork [\#2315](https://github.com/idnecology/idn/pull/2315)

* Added support for the upcoming CALAVERAS ephemeral testnet and removed the configuration for the deprecated BAIKAL ephemeral testnet. [\#2343](https://github.com/idnecology/idn/pull/2343)

### Bug Fixes
* Fix invalid transfer values with the tracing API specifically for CALL operation [\#2319](https://github.com/idnecology/idn/pull/2319)

### Early Access Features

#### Previously identified known issues

- Fixed issue in discv5 where nonce was incorrectly reused. [\#2075](https://github.com/idnecology/idn/pull/2075)
- Fixed issues in debug_standardTraceBadBlockToFile and debug_standardTraceBlockToFile. [\#2120](https://github.com/idnecology/idn/pull/2120)
- Fixed invalid error code in several JSON RPC methods when the requested block is not in the range. [\#2138](https://github.com/idnecology/idn/pull/2138)

## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.7/idn-21.1.7.zip
...
* Added support for the upcoming BAIKAL ephemeral testnet and removed the configuration for the deprecated YOLOv3 ephemeral testnet. [\#2237](https://github.com/idnecology/idn/pull/2237)
* Implemented [EIP-3541](https://eips.ethereum.org/EIPS/eip-3541): Reject new contracts starting with the 0xEF byte [\#2243](https://github.com/idnecology/idn/pull/2243)
* Implemented [EIP-3529](https://eips.ethereum.org/EIPS/eip-3529): Reduction in refunds [\#2238](https://github.com/idnecology/idn/pull/2238)
* Implemented [EIP-3554](https://eips.ethereum.org/EIPS/eip-3554): Difficulty Bomb Delay [\#2289](https://github.com/idnecology/idn/pull/2289)
* \[EXPERIMENTAL\] Added support for secp256r1 keys. [#2008](https://github.com/idnecology/idn/pull/2008)

### Bug Fixes

- Added ACCESS_LIST transactions to the list of transactions using legacy gas pricing for 1559 [\#2239](https://github.com/idnecology/idn/pull/2239)
- Reduced logging level of public key decoding failure of malformed packets. [\#2143](https://github.com/idnecology/idn/pull/2143)
- Add 1559 parameters to json-rpc responses.  [\#2222](https://github.com/idnecology/idn/pull/2222)
...
## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.6/idn-21.1.6.zip
...
- Ignore `nonce` when supplied to eth_estimateGas or eth_call. [\#2133](https://github.com/idnecology/idn/pull/2133)
- Ignore `privateFor` for tx estimation. [\#2160](https://github.com/idnecology/idn/pull/2160)

### Bug Fixes

- Fixed `NullPointerException` when crossing network upgrade blocks when peer discovery is disabled. [\#2140](https://github.com/idnecology/idn/pull/2140)
...
## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.5/idn-21.1.5.zip
...
- Adds `--discovery-dns-url` CLI command [\#2088](https://github.com/idnecology/idn/pull/2088)
...
## Download Link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.4/idn-21.1.4.zip
58ae55b492680d92aeccfbed477e8b9c25ccc1a97cca71895e27448d754a7d8b

## 21.1.3

### Additions and Improvements
* Increase node diversity when downloading blocks [\#2033](https://github.com/idnecology/idn/pull/2033)

### Bug Fixes
* Ethereum Node Records are now dynamically recalculated when we pass network upgrade blocks. This allows for better peering through transitions without needing to restart the node. [\#1998](https://github.com/idnecology/idn/pull/1998)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.3/idn-21.1.3.zip
...
- Added option to set a limit for JSON-RPC connections
  * HTTP connections `--rpc-http-max-active-connections` [\#1996](https://github.com/idnecology/idn/pull/1996)
  * WS connections `--rpc-ws-max-active-connections` [\#2006](https://github.com/idnecology/idn/pull/2006)
- Added ASTOR testnet ETC support [\#2017](https://github.com/idnecology/idn/pull/2017)
### Bug Fixes
* Don't Register BLS12 precompiles for Berlin [\#2015](https://github.com/idnecology/idn/pull/2015)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/21.1.2/idn-21.1.2.zip
...
### Additions and Improvements
* Removed EIP-2315 from the Berlin network upgrade [\#1983](https://github.com/idnecology/idn/pull/1983)
* Added `idn_transaction_pool_transactions` to the reported metrics, counting the mempool size [\#1869](https://github.com/idnecology/idn/pull/1869)
* Distributions and maven artifacts have been moved off of bintray [\#1886](https://github.com/idnecology/idn/pull/1886)
* admin_peers json RPC response now includes the remote nodes enode URL
* add support for keccak mining and a ecip1049_dev network [\#1882](https://github.com/idnecology/idn/pull/1882)
### Bug Fixes
* Fixed incorrect `groupId` in published maven pom files.
* Fixed GraphQL response for missing account, return empty account instead [\#1946](https://github.com/idnecology/idn/issues/1946)
...
### Additions and Improvements
* Added `idn_transaction_pool_transactions` to the reported metrics, counting the mempool size [\#1869](https://github.com/idnecology/idn/pull/1869)
* Added activation blocks for Berlin Network Upgrade [\#1929](https://github.com/idnecology/idn/pull/1929)
...
### Additions and Improvements
* Removed unused flags in default genesis configs [\#1812](https://github.com/idnecology/idn/pull/1812)
* `--skip-pow-validation-enabled` is now an error with `block import --format JSON`. This is because the JSON format doesn't include the nonce so the proof of work must be calculated. [\#1815](https://github.com/idnecology/idn/pull/1815)
* Added a new CLI option `--Xlauncher` to start a mainnet launcher. It will help to configure Idn easily.
* Return the revert reason from `eth_call` JSON-RPC api calls when the contract causes a revert. [\#1829](https://github.com/idnecology/idn/pull/1829)
* Added `chainId`, `publicKey`, and `raw` to JSON-RPC api calls returning detailed transaction results. [\#1835](https://github.com/idnecology/idn/pull/1835)

### Bug Fixes
* Ethereum classic heights will no longer be reported in mainnet metrics. Issue [\#1751](https://github.com/idnecology/idn/pull/1751) Fix [\#1820](https://github.com/idnecology/idn/pull/1820)
* Don't enforce balance checks in `eth_call` unless explicitly requested. Issue [\#502](https://github.com/idnecology/idn/pull/502) Fix [\#1834](https://github.com/idnecology/idn/pull/1834)
...
### Additions and Improvements
* Implemented [EIP-778](https://eips.ethereum.org/EIPS/eip-778): Ethereum Node Records (ENR) [\#1680](https://github.com/idnecology/idn/pull/1680)
* Implemented [EIP-868](https://eips.ethereum.org/EIPS/eip-868): Node Discovery v4 ENR Extension [\#1721](https://github.com/idnecology/idn/pull/1721)
* Added revert reason to eth_estimateGas RPC call. [\#1730](https://github.com/idnecology/idn/pull/1730)
* Added command line option --static-nodes-file. [#1644](https://github.com/idnecology/idn/pull/1644)
* Implemented [EIP-1898](https://eips.ethereum.org/EIPS/eip-1898): Add `blockHash` to JSON-RPC methods which accept a default block parameter [\#1757](https://github.com/idnecology/idn/pull/1757)

### Bug Fixes
* Accept locally-sourced transactions below the minimum gas price. [#1480](https://github.com/idnecology/idn/issues/1480) [#1743](https://github.com/idnecology/idn/pull/1743)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/20.10.4/idn-20.10.4.zip
sha256: f15cd5243b809659bba1706c1745aecafc012d3fc44a91419522da925493537c

## 20.10.3

### Additions and Improvements
* Added `memory` as an option to `--key-value-storage`.  This ephemeral storage is intended for sync testing and debugging.  [\#1617](https://github.com/idnecology/idn/pull/1617)
* Fixed gasPrice parameter not always respected when passed to `eth_estimateGas` endpoint [\#1636](https://github.com/idnecology/idn/pull/1636)
* Enabled eth65 by default [\#1682](https://github.com/idnecology/idn/pull/1682)
* Warn that bootnodes will be ignored if specified with discovery disabled [\#1717](https://github.com/idnecology/idn/pull/1717)

### Bug Fixes
* Accept to use default port values if not in use. [#1673](https://github.com/idnecology/idn/pull/1673)
* Block Validation Errors should be at least INFO level not DEBUG or TRACE.  Bug [\#1568](https://github.com/idnecology/idn/pull/1568) PR [\#1706](https://github.com/idnecology/idn/pull/1706)
* Fixed invalid and wrong trace data, especially when calling a precompiled contract [#1710](https://github.com/idnecology/idn/pull/1710)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/20.10.3/idn-20.10.3.zip
sha256: `b5f46d945754dedcbbb1e5dd96bf2bfd13272ff09c6a66c0150b979a578f4389`

## 20.10.2

### Additions and Improvements
* Added support for batched requests in WebSockets. [#1583](https://github.com/idnecology/idn/pull/1583)
* Added protocols section to `admin_peers` to provide info about peer health. [\#1582](https://github.com/idnecology/idn/pull/1582)
* Added CLI option `--goquorum-compatibility-enabled` to enable GoQuorum compatibility mode. [#1598](https://github.com/idnecology/idn/pull/1598). Note that this mode is incompatible with Mainnet.

### Bug Fixes

* Ibft2 will discard any received messages targeting a chain height <= current head - this resolves some corner cases in system correctness directly following block import. [#1575](https://github.com/idnecology/idn/pull/1575)
* EvmTool now throws `UnsupportedForkException` when there is an unknown fork and is YOLOv2 compatible [\#1584](https://github.com/idnecology/idn/pull/1584)
* `eth_newFilter` now supports `blockHash` parameter as per the spec [\#1548](https://github.com/idnecology/idn/issues/1540). (`blockhash` is also still supported.)
* Fixed an issue that caused loss of peers and desynchronization when eth65 was enabled [\#1601](https://github.com/idnecology/idn/pull/1601)
...
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/20.10.2/idn-20.10.2.zip
sha256: `710aed228dcbe9b8103aef39e4431b0c63e73c3a708ce88bcd1ecfa1722ad307`

## 20.10.1

### Additions and Improvements
* `--random-peer-priority-enabled` flag added. Allows for incoming connections to be prioritized randomly. This will prevent (typically small, stable) networks from forming impenetrable peer cliques. [#1440](https://github.com/idnecology/idn/pull/1440)
* `miner_changeTargetGasLimit` RPC added. If a target gas limit is set, allows the node operator to change it at runtime.
* Hide deprecated `--host-whitelist` option. [\#1444](https://github.com/idnecology/idn/pull/1444)
* Prioritize high gas prices during mining. Previously we ordered only by the order in which the transactions were received. This will increase expected profit when mining. [\#1449](https://github.com/idnecology/idn/pull/1449)
* Added support for the updated smart contract-based [node permissioning EEA interface](https://entethalliance.github.io/client-spec/spec.html#dfn-connectionallowed). [\#1435](https://github.com/idnecology/idn/pull/1435) and [\#1496](https://github.com/idnecology/idn/pull/1496)
* Added EvmTool binary to the distribution.  EvmTool is a CLI that can execute EVM bytecode and execute ethereum state tests. [\#1465](https://github.com/idnecology/idn/pull/1465)
* Updated the libraries for secp256k1 and AltBN series precompiles. These updates provide significant performance improvements to those areas. [\#1499](https://github.com/idnecology/idn/pull/1499)
* Provide MegaGas/second measurements in the log when doing a full block import, such as the catch up phase of a fast sync. [\#1512](https://github.com/idnecology/idn/pull/1512)
* Added new endpoints to get miner data, `eth_getMinerDataByBlockHash` and `eth_getMinerDataByBlockNumber`. [\#1538](https://github.com/idnecology/idn/pull/1538)
* Added direct support for OpenTelemetry metrics [\#1492](https://github.com/idnecology/idn/pull/1492)
* Added support for `qip714block` config parameter in genesis file, paving the way towards permissioning interoperability between Idn and GoQuorum. [\#1545](https://github.com/idnecology/idn/pull/1545)
* Added new CLI option `--compatibility-eth64-forkid-enabled`. [\#1542](https://github.com/idnecology/idn/pull/1542)

### Bug Fixes

* Fix a bug on `eth_estimateGas` which returned `Internal error` instead of `Execution reverted` in case of reverted transaction. [\#1478](https://github.com/idnecology/idn/pull/1478)
* Fixed a bug where Local Account Permissioning was being incorrectly enforced on block import/validation. [\#1510](https://github.com/idnecology/idn/pull/1510)
* Fixed invalid enode URL when discovery is disabled  [\#1521](https://github.com/idnecology/idn/pull/1521)
* Removed duplicate files from zip and tar.gz distributions. [\#1566](https://github.com/idnecology/idn/pull/1566)
* Add a more rational value to eth_gasPrice, based on a configurable percentile of prior block's transactions (default: median of last 100 blocks).  [\#1563](https://github.com/idnecology/idn/pull/1563)

## Deprecated

### --privacy-precompiled-address (Scheduled for removal in _Next_ Release)
Deprecated in 1.5.1
- CLI option `--privacy-precompiled-address` option removed. This address is now derived, based	on `--privacy-onchain-groups-enabled`. [\#1222](https://github.com/idnecology/idn/pull/1222)

### Idn Sample Network repository

The [Idn Sample Networks repository](https://github.com/ConsenSys/idn-sample-networks) has been replaced by the [Quorum Developer Quickstart](https://idn.idnecology.org/en/latest/Tutorials/Developer-Quickstart).
...
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/20.10.1/idn-20.10.1.zip
...
Idn ecology Idn is moving its versioning scheme to [CalVer](https://calver.org/) starting with the 20.10.0 (formerly 1.6.0) release. More information about the specific version of CalVer Idn is using can be found on the [wiki](https://wiki.idnecology.org/display/BESU/Using+CalVer+for+Idn+Releases).

## 20.10 Breaking Changes

When upgrading to 20.10, ensure you've taken into account the following breaking changes.

### JSON-RPC HTTP Error Codes For Valid Calls ([\#1426](https://github.com/idnecology/idn/pull/1426))
...
* Added support for ECIP-1099 / Classic Thanos Fork: Calibrate Epoch Duration. [\#1421](https://github.com/idnecology/idn/pull/1421) [\#1441](https://github.com/idnecology/idn/pull/1441) [\#1462](https://github.com/idnecology/idn/pull/1462)
* Added the Open Telemetry Java agent to report traces to a remote backend. Added an example to showcase the trace reporting capabilities.
* Added EvmTool binary to the distribution.  EvmTool is a CLI that can execute EVM bytecode and execute ethereum state tests. Documentation for it is available [here](https://idn.idnecology.org/en/stable/HowTo/Troubleshoot/Use-EVM-Tool/). [\#1465](https://github.com/idnecology/idn/pull/1465)
* Added support for the upcoming YOLOv2 ephemeral testnet and removed the flag for the deprecated YOLOv1 ephemeral testnet. [#1386](https://github.com/idnecology/idn/pull/1386)
* Added `debug_standardTraceBlockToFile` JSON-RPC API. This API accepts a block hash and will replay the block. It returns a list of files containing the result of the trace (one file per transaction). [\#1392](https://github.com/idnecology/idn/pull/1392)
* Added `debug_standardTraceBadBlockToFile` JSON-RPC API. This API is similar to `debug_standardTraceBlockToFile`, but can be used to obtain info about a block which has been rejected as invalid. [\#1403](https://github.com/idnecology/idn/pull/1403)
* Added support for EIP-2929 to YOLOv2. [#1387](https://github.com/idnecology/idn/pull/1387)
* Added `--start-block` and `--end-block` to the `blocks import` subcommand [\#1399](https://github.com/idnecology/idn/pull/1399)
* Added support for multi-tenancy when using the early access feature of [onchain privacy group management](https://idn.idnecology.org/en/stable/Concepts/Privacy/Onchain-PrivacyGroups/)
* \[Reverted\] Fixed memory leak in eth/65 subprotocol behavior. It is now enabled by default. [\#1420](https://github.com/idnecology/idn/pull/1420), [#1348](https://github.com/idnecology/idn/pull/1348), [#1321](https://github.com/idnecology/idn/pull/1321)

### Bug Fixes

* Log block import rejection reasons at "INFO" level.  Bug [#1412](https://github.com/idnecology/idn/issues/1412)
* Fixed NPE when executing `eth_estimateGas` with privacy enabled.  Bug [#1404](https://github.com/idnecology/idn/issues/1404)
...
on `--privacy-onchain-groups-enabled`. [\#1222](https://github.com/idnecology/idn/pull/1222)

### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/20.10.0/idn-20.10.0.zip
...
### Bug Fixes
* Added `debug_getBadBlocks` JSON-RPC API to analyze and detect consensus flaws. Even if a block is rejected it will be returned by this method [\#1378](https://github.com/idnecology/idn/pull/1378)
* Fix logs queries missing results against chain head [\#1351](https://github.com/idnecology/idn/pull/1351) and [\#1381](https://github.com/idnecology/idn/pull/1381)
...
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.5/idn-1.5.5.zip
...
* Added `priv_debugGetStateRoot` JSON-RPC API to retrieve the state root of a specified privacy group. [\#1326](https://github.com/idnecology/idn/pull/1326)
...
* Added `debug_batchSendRawTransaction` JSON-RPC API to submit multiple signed transactions with a single call. [\#1350](https://github.com/idnecology/idn/pull/1350)

### Bug Fixes

* The metrics HTTP server no longer rejects requests containing `Accept` header that doesn't precisely match the prometheus text format [\#1345](https://github.com/idnecology/idn/pull/1345)
* JSON-RPC method `net_version` should return network ID instead of chain ID [\#1355](https://github.com/idnecology/idn/pull/1355)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.4/idn-1.5.4.zip
...
* The EvmTool now processes State Tests from the Ethereum Reference Tests. [\#1311](https://github.com/idnecology/idn/pull/1311)
* Early access DNS support added via the `--Xdns-enabled` and `--Xdns-update-enabled` CLI options. [\#1247](https://github.com/idnecology/idn/pull/1247)
* Add genesis config option `ecip1017EraRounds` for Ethereum Classic chains. [\#1329](https://github.com/idnecology/idn/pull/1329)

### Bug Fixes

* K8S Permissioning to use of Service IP's rather than pod IP's which can fail [\#1190](https://github.com/idnecology/idn/issues/1190)
...
This [early access feature](https://idn.idnecology.org/en/stable/Concepts/Privacy/Onchain-PrivacyGroups/) was changed in a way that makes onchain privacy groups created with previous versions no longer usable.
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.3/idn-1.5.3.zip
...
* Experimental offline backup and restore has been added via the `operator x-backup-state` and `operator x-restore-state` CLI commands.  Data formats will be fluid for as long as the `x-` prefix is present in the CLI so it is advised not to rely on these backups for disaster recovery. [\#1235](https://github.com/idnecology/idn/pull/1235)
* Experimental ethstats support added via the `Xethstats` and `Xethstats-contact` CLI commands. [\#1239](https://github.com/idnecology/idn/pull/1239)
* Peers added via the JSON-RPC `admin_addPeer` and `admin_removePeer` will be shared or no longer shared via discovery respectively.  Previously they were not shared. [\#1177](https://github.com/idnecology/idn/pull/1177) contributed by [br0tchain](https://github.com/br0tchain).
* New Docker Images (see below). [\#1277](https://github.com/idnecology/idn/pull/1277)
* Reworked static peer discovery handling. [\#1292](https://github.com/idnecology/idn/pull/1292)
...
### Bug Fixes
- Offchain permissioning - fixed bug where sync status check prevented peering if static nodes configured. [\#1252](https://github.com/idnecology/idn/issues/1252)

- GraphQL queries of `miner` in IBFT networks will no longer return an error.  PR [\#1282](https://github.com/idnecology/idn/pull/1282) issue [\#1272](https://github.com/idnecology/idn/issues/1272).
...
- [David Mechler](https://github.com/idnecology/idn/commits?author=davemec) has been added as a [new maintainer](https://github.com/idnecology/idn/pull/1267).
- [Edward Evans](https://github.com/idnecology/idn/commits?author=EdJoJob) voluntarily moved to [emeritus status](https://github.com/idnecology/idn/pull/1270).

### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.2/idn-1.5.2.zip
...
* In an IBFT2 network, a fixed block reward value and recipient address can be defined in genesis file [\#1132](https://github.com/idnecology/idn/pull/1132)
* JSON-RPC HTTP API Authorization: exit early when checking user permissions. [\#1144](https://github.com/idnecology/idn/pull/1144)
* HTTP/2 is enabled for JSON-RPC HTTP API over TLS. [\#1145](https://github.com/idnecology/idn/pull/1145)
* Color output in consoles. It can be disabled with `--color-enabled=false` [\#1257](https://github.com/idnecology/idn/pull/1257)
* Add compatibility with ClusterIP services for the Kubernetes Nat Manager  [\#1156](https://github.com/idnecology/idn/pull/1156)
* In an IBFT2 network; a fixed block reward value and recipient address can be defined in genesis file [\#1132](https://github.com/idnecology/idn/pull/1132)
* Add fee cap for transactions submitted via RPC. [\#1137](https://github.com/idnecology/idn/pull/1137)

### Bug fixes

* When the default sync mode was changed to fast sync for named networks, there was one caveat we didn't address. The `dev` network should've been full sync by default. This has now been fixed. [\#1257](https://github.com/idnecology/idn/pull/1257)
* Fix synchronization timeout issue when the blocks were too large [\#1149](https://github.com/idnecology/idn/pull/1149)
* Fix missing results from eth_getLogs request. [\#1154](https://github.com/idnecology/idn/pull/1154)
* Fix issue allowing Idn to be used for DDoS amplification. [\#1146](https://github.com/idnecology/idn/pull/1146)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.1/idn-1.5.1.zip
...
* Tracing
  The [Tracing API](https://idn.idnecology.org/en/latest/Reference/API-Methods/#trace-methods) is no longer an Early Access feature and now has full support for `trace_replayBlockTransactions`, `trace_Block` and `trace_transaction`.
* Plugin API Block Events
  `BlockAdded` and `BlockReorg` are now exposed via the [Plugin API](https://javadoc.io/doc/org.idnecology.idn/plugin-api/latest/org/idnecology/idn/plugin/services/IdnEvents.html).
* [Filters](https://idn.idnecology.org/en/stable/HowTo/Interact/Filters/Accessing-Logs-Using-JSON-RPC/) and
  [subscriptions](https://idn.idnecology.org/en/stable/HowTo/Interact/APIs/RPC-PubSub/) for private contracts.
* [SecurityModule Plugin API](https://javadoc.io/doc/org.idnecology.idn/plugin-api/latest/org/idnecology/idn/plugin/services/SecurityModuleService.html)
  This allows use of a different [security module](https://idn.idnecology.org/en/stable/Reference/CLI/CLI-Syntax/#security-module)
  as a plugin to provide cryptographic function that can be used by NodeKey (such as sign, ECDHKeyAgreement etc.).
* [Onchain privacy groups](https://idn.idnecology.org/en/latest/Concepts/Privacy/Onchain-PrivacyGroups/)
...
* Public Networks Default to Fast Sync: The default sync mode for named permissionless networks, such as the Ethereum mainnet and testnets, is now `FAST`.
  ...
  * Use the [`--sync-mode` command line option](https://idn.idnecology.org/Reference/CLI/CLI-Syntax/#sync-mode) to change the sync mode. [\#384](https://github.com/idnecology/idn/pull/384)
* Proper Mining Support: Added full support for `eth_hashrate` and `eth_submitHashrate`. It is now possible to have the hashrate when we mine with a GPU mining worker [\#1063](https://github.com/idnecology/idn/pull/1063)
* Performance Improvements: The addition of native libraries ([\#775](https://github.com/idnecology/idn/pull/775)) and changes to data structures in the EVM ([\#1089](https://github.com/idnecology/idn/pull/1089)) have improved Idn sync and EVM execution times.
* Tracing API Improvements: The [Tracing API](https://idn.idnecology.org/en/latest/Reference/API-Methods/#trace-methods) is no longer an Early Access feature and now has full support for `trace_replayBlockTransactions`, `trace_Block` and `trace_transaction`.
* New Plugin API Block Events: `BlockAdded` and `BlockReorg` are now exposed via the Plugin API [\#637](https://github.com/idnecology/idn/pull/637).
* Added experimental CLI option `--Xnat-kube-pod-name` to specify the name of the loadbalancer used by the Kubernetes nat manager [\#1078](https://github.com/idnecology/idn/pull/1078)
- Local permissioning TOML config now supports additional keys (`nodes-allowlist` and `accounts-allowlist`).
Support for `nodes-whitelist` and `accounts-whitelist` will be removed in a future release.
- Add missing `mixHash` field for `eth_getBlockBy*` JSON RPC endpoints. [\#1098](https://github.com/idnecology/idn/pull/1098)
...
No bug fixes with [user impact in this release](https://wiki.idnecology.org/display/BESU/Changelog).
...
- K8S permissioning uses of Service IPs rather than pod IPs which can fail. [\#1190](https://github.com/idnecology/idn/pull/1190)
Workaround - Do not use permissioning on K8S.

- Restart caused by insufficient memory can cause inconsistent private state. [\#1110](https://github.com/idnecology/idn/pull/1110)
...
### Download link
https://idnecology.jfrog.io/artifactory/idn-binaries/idn/1.5.0/idn-1.5.0.zip

sha256sum: `56929d6a71cc681688351041c919e9630ab6df7de37dd0c4ae9e19a4f44460b2`

**For download links of releases prior to 1.5.0, please visit https://idnecology.jfrog.io/artifactory/idn-binaries/idn/**

## 1.4.6

### Additions and Improvements

- Print node address on startup. [\#938](https://github.com/idnecology/idn/pull/938)
- Transaction pool: price bump replacement mechanism configurable through CLI. [\#928](https://github.com/idnecology/idn/pull/928) [\#930](https://github.com/idnecology/idn/pull/930)

### Bug Fixes

- Added timeout to queries. [\#986](https://github.com/idnecology/idn/pull/986)
- Fixed issue where networks using onchain permissioning could stall when the bootnodes were not validators. [\#969](https://github.com/idnecology/idn/pull/969)
- Update getForks method to ignore ClassicForkBlock chain parameter to fix issue with ETC syncing. [\#1014](https://github.com/idnecology/idn/pull/1014)
...
- Implemented WebSocket logs subscription for private contracts (`priv_subscribe`/`priv_unsubscribe`) [\#762](https://github.com/idnecology/idn/pull/762)
- Introduced SecurityModule plugin API. This allows use of a different security module as a plugin to
  provide cryptographic function that can be used by NodeKey (such as sign, ECDHKeyAgreement etc.). KeyPairSecurityModule
  is registered and used by default. The CLI option `--security-module=<name> (defaults to localfile)` can be used
  to identify the security module plugin name to use instead. [\#713](https://github.com/idnecology/idn/pull/713)
- Several testing related changes to improve compatibility with [Hive](https://hivetests.ethdevops.io/) and Retesteth.
  [\#806](https://github.com/idnecology/idn/pull/806) and [#845](https://github.com/idnecology/idn/pull/845)
- Native libraries for secp256k1 and Altbn128 encryption are enabled by default.  To disable these libraries use
  `--Xsecp256k1-native-enabled=false` and `--Xaltbn128-native-enabled=false`. [\#775](https://github.com/idnecology/idn/pull/775)

### Bug Fixes

- Fixed `eth_estimateGas` JSON RPC so it no longer returns gas estimates that are too low. [\#842](https://github.com/idnecology/idn/pull/842)
- Full help not displayed unless explicitly requested. [\#437](https://github.com/idnecology/idn/pull/437)
- Compatibility with undocumented Geth `eth_subscribe` fields. [\#654](https://github.com/idnecology/idn/pull/654)
- Current block number included as part of `eth_getWork` response. [\#849](https://github.com/idnecology/idn/pull/849)
...
* Scope of logs query causing Idn to crash. [\#944](https://github.com/idnecology/idn/pull/944)
...
- Implemented [`priv_getLogs`](https://idn.idnecology.org/en/latest/Reference/API-Methods/#priv_getlogs). [\#686](https://github.com/idnecology/idn/pull/686)
- Implemented private contract log filters including JSON-RPC methods to interact with private filters. [\#735](https://github.com/idnecology/idn/pull/735)
- Implemented EIP-2315: Simple Subroutines for the EVM [\#717](https://github.com/idnecology/idn/pull/717)
- Implemented Splunk logging. [\#725](https://github.com/idnecology/idn/pull/725)
- Implemented optional native library encryption. [\#675](https://github.com/idnecology/idn/pull/675).  To enable add `--Xsecp256k1-native-enabled` (for transaction signatures) and/or `--Xaltbn128-native-enabled` (for altbn128 precomiled contracts) as command line options.

### Bug Fixes

- Flag added to toggle `eth/65` off by default. `eth/65` will remain toggled off by default until
a fix is completed for the [eth/65 known issue](KNOWN_ISSUES.md). [\#741](https://github.com/idnecology/idn/pull/741)
- Resolve crashing NAT detectors on GKE. [\#731](https://github.com/idnecology/idn/pull/731) fixes [\#507](https://github.com/idnecology/idn/issues/507).
...
- Deal with quick service start failures [\#714](https://github.com/idnecology/idn/pull/714) fixes [\#662](https://github.com/idnecology/idn/issues/662)
...
- `Intrinsic gas exceeds gas limit` returned when calling `delete mapping[addr]` or `mapping[addr] = 0` [\#696](https://github.com/idnecology/idn/issues/696)
...
The `eth/65` change is not [backwards compatible](https://github.com/idnecology/idn/issues/723).
...
A [fix](https://github.com/idnecology/idn/pull/732) is currently [being tested](https://github.com/idnecology/idn/pull/733).
...
- Added `eth/65` support. [\#608](https://github.com/idnecology/idn/pull/608)
- Added block added and block reorg events. Added revert reason to block added transactions. [\#637](https://github.com/idnecology/idn/pull/637)

### Deprecated

- Private Transaction `hash` field and `getHash()` method have been deprecated. They will be removed
in 1.5.0 release. [\#639](https://github.com/idnecology/idn/pull/639)
...
- Error syncing with mainnet on Idn 1.3.7 node - MerkleTrieException [\#580](https://github.com/idnecology/idn/issues/580)
...
pivot block. [\#683](https://github.com/idnecology/idn/issues/683)
...
- Onchain permissioning nodes can't peer when using a non-validator bootnode [\#528](https://github.com/idnecology/idn/issues/528)
...
- Added `trace_block` JSON RPC API [\#449](https://github.com/idnecology/idn/pull/449)
- Added `pulledStates` and `knownStates` to the EthQL `syncing` query and `eth_syncing` JSON-RPC api [\#565](https://github.com/idnecology/idn/pull/565)

### Bug Fixes

- Fixed file parsing behaviour for privacy enclave keystore password file [\#554](https://github.com/idnecology/idn/pull/554) (thanks to [magooster](https://github.com/magooster))
- Fixed known issue with being unable to re-add members to onchain privacy groups [\#471](https://github.com/idnecology/idn/pull/471)

### Updated Early Access Features

* [Onchain privacy groups](https://idn.idnecology.org/en/latest/Concepts/Privacy/Onchain-PrivacyGroups/) with add and remove members. Known issue resolved (see above).
* [TRACE API](https://idn.idnecology.org/en/latest/Reference/API-Methods/#trace-methods) now includes `trace_block`, `trace_replayBlockTransactions`, and `trace_transaction`.
Fixed some issues on the trace replay block transactions API [\#522](https://github.com/idnecology/idn/pull/522).
...
A fix to remove the default to full sync is [in progress](https://github.com/idnecology/idn/pull/427)
is being actively worked on.

#### Error full syncing with pruning

- Error syncing with mainnet on Idn 1.3.7 node - MerkleTrieException [\#BESU-160](https://jira.idnecology.org/browse/BESU-160)
The associated error is `Unable to load trie node value for hash` and is caused by the combination of
full sync and pruning.
...
- Onchain permissioning nodes can't peer when using a non-validator bootnode [\#BESU-181](https://jira.idnecology.org/browse/BESU-181)
...
- Added priv_getCode [\#250](https://github.com/idnecology/idn/pull/408). Gets the bytecode associated with a private address.
- Added `trace_transaction` JSON RPC API [\#441](https://github.com/idnecology/idn/pull/441)
- Removed -X unstable prefix for pruning options (`--pruning-blocks-retained`, `--pruning-block-confirmations`) [\#440](https://github.com/idnecology/idn/pull/440)
- Implemented [ECIP-1088](https://ecips.ethereumclassic.org/ECIPs/ecip-1088): Phoenix EVM and Protocol upgrades. [\#434](https://github.com/idnecology/idn/pull/434)

### Bug Fixes

- [BESU-25](https://jira.idnecology.org/browse/BESU-25) Use v5 Devp2p when pinging [\#392](https://github.com/idnecology/idn/pull/392)
- Fixed a bug to manage concurrent access to cache files [\#438](https://github.com/idnecology/idn/pull/438)
- Fixed configuration file bug: `pruning-blocks-retained` now accepts an integer in the config [\#440](https://github.com/idnecology/idn/pull/440)
- Specifying RPC credentials file should not force RPC Authentication to be enabled [\#454](https://github.com/idnecology/idn/pull/454)
- Enhanced estimateGas messages [\#436](https://github.com/idnecology/idn/pull/436). When a estimateGas request fails a validation check, an improved error message is returned in the response.
...
* [Onchain privacy groups](https://idn.idnecology.org/en/latest/Concepts/Privacy/Onchain-PrivacyGroups/) with add and remove members.
  Not being able to re-add a member to an onchain privacy group is a [known issue](https://github.com/idnecology/idn/issues/455)
...
* [TLS support](https://idn.idnecology.org/en/latest/Concepts/TLS/) to secure client and server communication.

* [Multi-tenancy](https://idn.idnecology.org/en/latest/Concepts/Privacy/Multi-Tenancy/) to enable multiple participants to use the same Idn and Orion node.

* [Plugin APIs](https://idn.idnecology.org/en/latest/Concepts/Plugins/) to enable building of Java plugins to extend Idn ecology Idn.

* Support for additional [NAT methods](https://idn.idnecology.org/en/latest/HowTo/Find-and-Connect/Specifying-NAT/).

* Added [`priv_call`](https://idn.idnecology.org/en/latest/Reference/API-Methods/#priv_call) which invokes
a private contract function locally and does not change the private state.

* Idn has moved from an internal Bytes library to the [Apache Tuweni](https://tuweni.apache.org/) Bytes library.
This includes using the library in the Plugins API interfaces. [#295](https://github.com/idnecology/idn/pull/295) and [#215](https://github.com/idnecology/idn/pull/215)
...
* [Reorg compatible privacy](https://idn.idnecology.org/en/latest/Concepts/Privacy/Privacy-Overview/#reorg-compatible-privacy)
to enable private transactions on networks using consensus mechanisms that fork.

* [Tracing API](https://idn.idnecology.org/en/latest/Concepts/Transactions/Trace-Types) to obtain detailed information about transaction processing.
...
- Added [Multi-tenancy](https://idn.idnecology.org/en/latest/Concepts/Privacy/Multi-Tenancy/) support which allows multiple participants to use the same Idn node for private transactions.

- Added TLS support for communication with privacy enclave

### Bug Fixes

- Private transactions are now validated before sent to the enclave [\#356](https://github.com/idnecology/idn/pull/356)
...
- CLI option to enable TLS client auth for JSON-RPC HTTP [\#340](https://github.com/idnecology/idn/pull/340)
...
- Stable Plugins APIs [\#346](https://github.com/idnecology/idn/pull/346)

The `IdnEvents` service and related `data` package have been marked as a stable plugin API.

### Bug Fixes

- Return missing signers from getSignerMetrics [\#343](https://github.com/idnecology/idn/pull/)
...
- Enable TLS for JSON-RPC HTTP Service [\#253](https://github.com/idnecology/idn/pull/253)
...
- TotalDifficulty is a BigInteger [\#253](https://github.com/idnecology/idn/pull/253).
...
- Idn has moved from an internal Bytes library to the [Apache Tuweni](https://tuweni.apache.org/) Bytes library.  This includes using the library in the Plugins API interfaces. [#295](https://github.com/idnecology/idn/pull/295) and [#215](https://github.com/idnecology/idn/pull/215)
- Idn stops processing blocks if Orion is unavailable [\#253](https://github.com/idnecology/idn/pull/253)
- Added priv_call [\#250](https://github.com/idnecology/idn/pull/250).  Invokes a private contract function locally and does not change the private state.
- Support for [EIP-2124](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-2124.md), which results in faster peer discovery [\#156](https://github.com/idnecology/idn/pull/156)

## 1.3.8

### Additions and Improvements

- `admin_generateLogBloomCache` JSON-RPC API to generate a cache of the block bloombits that improves performance for log queries [\#262](https://github.com/idnecology/idn/pull/262)
...
For more details, see [Idn ecology Idn Wiki](https://wiki.idnecology.org/display/BESU/Mainnet+Consensus+Bug+Identified+and+Resolved+in+Idn ecology+Idn).
...
- Hard Fork Support: Configures the Agharta activation block for the ETC MainNet configuration [\#251](https://github.com/idnecology/idn/pull/251) (thanks to [soc1c](https://github.com/soc1c))
- `operator generate-log-bloom-cache` command line option to generate a cache of the block bloombits that improves performance for log queries  [\#245](https://github.com/idnecology/idn/pull/245)

### Bug Fixes

- Resolves a Mainnet consensus issue [\#254](https://github.com/idnecology/idn/pull/254)

### New Maintainer

[Edward Mack](https://github.com/idnecology/idn/commits?author=edwardmack) added as a [new maintainer](https://github.com/idnecology/idn/pull/219).
...
- Performance improvements:
  * Multithread Websockets to increase throughput [\#231](https://github.com/idnecology/idn/pull/231)
  * NewBlockHeaders performance improvement [\#230](https://github.com/idnecology/idn/pull/230)
- EIP2384 - Ice Age Adjustment around Istanbul [\#211](https://github.com/idnecology/idn/pull/211)
- Hard Fork Support:
...
- [\#210](https://github.com/idnecology/idn/pull/210) fixes WebSocket frames handling
...
- Log Event Streaming for Plugin API [\#186](https://github.com/idnecology/idn/pull/186)
- Allow use a external JWT public key in authenticated APIs [\#183](https://github.com/idnecology/idn/pull/183)
- ETC Configuration, classic fork peer validator [\#176](https://github.com/idnecology/idn/pull/176) (thanks to [edwardmack](https://github.com/edwardmack))
- Allow IBFT validators to be changed at a given block [\#173](https://github.com/idnecology/idn/pull/173)
- Support external mining using Stratum [\#140](https://github.com/idnecology/idn/pull/140) (thanks to [atoulme](https://github.com/atoulme))
- Add more fields to private transaction receipt [\#85](https://github.com/idnecology/idn/pull/85) (thanks to [josh-richardson](https://github.com/josh-richardson))
- [Pruning documentation](https://idn.idnecology.org/en/latest/Concepts/Pruning/)

### Technical Improvements

- ETC - Cleanup [\#201](https://github.com/idnecology/idn/pull/201) (thanks to [GregTheGreek](https://github.com/GregTheGreek))
- User specific enclave public key configuration in auth file [\#196](https://github.com/idnecology/idn/pull/196)
- Change CustomForks -\> Transitions [\#193](https://github.com/idnecology/idn/pull/193)
- Pass identity information into RpcMethod from Http Service [\#189](https://github.com/idnecology/idn/pull/189)
- Remove the use of JsonRpcParameters from RpcMethods [\#188](https://github.com/idnecology/idn/pull/188)
- Repaired Metrics name collision between Privacy and RocksDB [\#187](https://github.com/idnecology/idn/pull/187)
- Multi-Tenancy: Do not specify a public key anymore when requesting a … [\#185](https://github.com/idnecology/idn/pull/185)
- Updates to circle building acceptance tests [\#184](https://github.com/idnecology/idn/pull/184)
- Move Apache Tuweni dependency to official release [\#181](https://github.com/idnecology/idn/pull/181) (thanks to [atoulme](https://github.com/atoulme))
- Update Gradle to 6.0, support Java 13 [\#180](https://github.com/idnecology/idn/pull/180)
- ETC Atlantis fork [\#179](https://github.com/idnecology/idn/pull/179) (thanks to [edwardmack](https://github.com/edwardmack))
- ETC Gotham Fork [\#178](https://github.com/idnecology/idn/pull/178) (thanks to [edwardmack](https://github.com/edwardmack))
- ETC DieHard fork support [\#177](https://github.com/idnecology/idn/pull/177) (thanks to [edwardmack](https://github.com/edwardmack))
- Remove 'parentHash', 'number' and 'gasUsed' fields from the genesis d… [\#175](https://github.com/idnecology/idn/pull/175) (thanks to [SweeXordious](https://github.com/SweeXordious))
- Enable pruning by default for fast sync and validate conflicts with privacy [\#172](https://github.com/idnecology/idn/pull/172)
- Update RocksDB [\#170](https://github.com/idnecology/idn/pull/170)
- Vpdate ver to 1.3.5-snapshot [\#169](https://github.com/idnecology/idn/pull/169)
- Added PoaQueryService method that returns local node signer… [\#163](https://github.com/idnecology/idn/pull/163)
- Add versioning to privacy storage [\#149](https://github.com/idnecology/idn/pull/149)
- Update reference tests [\#139](https://github.com/idnecology/idn/pull/139)

### 1.3.4

- Reverted _Enable pruning by default for fast sync (#135)_ [\#164](https://github.com/idnecology/idn/pull/164)

### 1.3.3

### Technical Improvements

- Add --identity flag for client identification in node browsers [\#150](https://github.com/idnecology/idn/pull/150)
- Istanbul Mainnet Block [\#145](https://github.com/idnecology/idn/pull/150)
- Add priv\_getEeaTransactionCount [\#110](https://github.com/idnecology/idn/pull/110)

### Additions and Improvements

- Redesign of how JsonRpcMethods are created [\#159](https://github.com/idnecology/idn/pull/159)
- Moving JsonRpcMethods classes into the same package, prior to refactor [\#154](https://github.com/idnecology/idn/pull/154)
- Reflect default logging in CLI help [\#148](https://github.com/idnecology/idn/pull/148)
- Handle zero port better in NAT [\#147](https://github.com/idnecology/idn/pull/147)
- Rework how filter and log query parameters are created/used [\#146](https://github.com/idnecology/idn/pull/146)
- Don't generate shutdown tasks in controller [\#141](https://github.com/idnecology/idn/pull/141)
- Ibft queries [\#138](https://github.com/idnecology/idn/pull/138)
- Enable pruning by default for fast sync [\#135](https://github.com/idnecology/idn/pull/135)
- Ensure spotless runs in CI [\#132](https://github.com/idnecology/idn/pull/132)
- Add more logging around peer disconnects [\#131](https://github.com/idnecology/idn/pull/131)
- Repair EthGetLogs returning incorrect results [\#128](https://github.com/idnecology/idn/pull/128)
- Use Bloombits for Logs queries [\#127](https://github.com/idnecology/idn/pull/127)
- Improve message when extraData missing [\#121](https://github.com/idnecology/idn/pull/121)
- Fix miner startup logic [\#104](https://github.com/idnecology/idn/pull/104)
- Support log reordring from reorgs in `LogSubscriptionService` [\#86](https://github.com/idnecology/idn/pull/86)

### 1.3.2

### Additions and Improvements

- idn -v to print plugin versions[\#123](https://github.com/idnecology/idn/pull/123)

### Technical Improvements

- Update Governance and Code of Conduct verbiage [\#120](https://github.com/idnecology/idn/pull/120)
- Fix private transaction root mismatch [\#118](https://github.com/idnecology/idn/pull/118)
- Programmatically enforce plugin CLI variable names [\#117](https://github.com/idnecology/idn/pull/117)
- Additional unit test for selecting replaced pending transactions [\#116](https://github.com/idnecology/idn/pull/116)
- Only set sync targets that have an estimated height value [\#115](https://github.com/idnecology/idn/pull/115)
- Fix rlpx startup [\#114](https://github.com/idnecology/idn/pull/114)
- Expose getPayload in Transaction plugin-api interface. [\#113](https://github.com/idnecology/idn/pull/113)
- Dependency Version Upgrades [\#112](https://github.com/idnecology/idn/pull/112)
- Add hash field in Transaction plugin interface. [\#111](https://github.com/idnecology/idn/pull/111)
- Rework sync status events [\#106](https://github.com/idnecology/idn/pull/106)

### 1.3.1

### Additions and Improvements

- Added GraphQL query/logs support [\#94](https://github.com/idnecology/idn/pull/94)

### Technical Improvements

- Add totalDiffculty to BlockPropagated events. [\#97](https://github.com/idnecology/idn/pull/97)
- Merge BlockchainQueries classes [\#101](https://github.com/idnecology/idn/pull/101)
- Fixed casing of dynamic MetricCategorys [\#99](https://github.com/idnecology/idn/pull/99)
- Fix private transactions breaking evm [\#96](https://github.com/idnecology/idn/pull/96)
- Make SyncState variables thread-safe [\#95](https://github.com/idnecology/idn/pull/95)
- Fix transaction tracking by sender [\#93](https://github.com/idnecology/idn/pull/93)
- Make logic in PersistBlockTask more explicit to fix a LGTM warning [\#92](https://github.com/idnecology/idn/pull/92)
- Removed Unused methods in the transaction simulator. [\#91](https://github.com/idnecology/idn/pull/91)
- Fix ThreadIdnNodeRunner IdnConfiguration setup [\#90](https://github.com/idnecology/idn/pull/90)
- JsonRpc method disabled error condition rewrite and unit test [\#80](https://github.com/idnecology/idn/pull/80)
- Round trip testing of state trie account values [\#31](https://github.com/idnecology/idn/pull/31)

### 1.3

### Breaking Change

- Disallow comments in Genesis JSON file. [\#49](https://github.com/idnecology/idn/pull/49)

### Additions and Improvements

- Add `--required-block` command line option to deal with chain splits [\#79](https://github.com/idnecology/idn/pull/79)
- Store db metadata file in the root data directory. [\#46](https://github.com/idnecology/idn/pull/46)
- Add `--target-gas-limit` command line option. [\#24](https://github.com/idnecology/idn/pull/24)(thanks to new contributor [cfelde](https://github.com/cfelde))
- Allow private contracts to access public state. [\#9](https://github.com/idnecology/idn/pull/9)

### Technical Improvements

- Less verbose syncing subscriptions [\#59](https://github.com/idnecology/idn/pull/59)
- Return enclave key instead of private transaction hash [\#53](https://github.com/idnecology/idn/pull/53)
- Fix mark sweep pruner bugs where nodes that should be kept were being swept  [\#50](https://github.com/idnecology/idn/pull/50)
- Clean up IdnConfiguration construction [\#51](https://github.com/idnecology/idn/pull/51)
- Private tx nonce errors return same msg as any tx [\#48](https://github.com/idnecology/idn/pull/48)
- Fix default logging [\#47](https://github.com/idnecology/idn/pull/47)
- Introduce virtual operation. [\#45](https://github.com/idnecology/idn/pull/45)
- Downgrade RocksDBPlugin Logging Levels [\#44](https://github.com/idnecology/idn/pull/44)
- Infrastructure for exposing PoA metrics for plugins. [\#37](https://github.com/idnecology/idn/pull/37)
- Refactor privacy storage. [\#7](https://github.com/idnecology/idn/pull/7)

## 1.2.4

### Additions and Improvements

- Add Istanbul block (5435345) for Rinkeby [\#35](https://github.com/idnecology/idn/pull/35)
- Add Istanbul block (1561651) for Goerli [\#27](https://github.com/idnecology/idn/pull/27)
- Add Istanbul block (6485846) for Ropsten [\#26](https://github.com/idnecology/idn/pull/26)
- Add privDistributeRawTransaction endpoint [\#23](https://github.com/idnecology/idn/pull/23) (thanks to [josh-richardson](https://github.com/josh-richardson))

### Technical Improvements

- Refactors pantheon private key to signing private key [\#34](https://github.com/idnecology/idn/pull/34) (thanks to [josh-richardson](https://github.com/josh-richardson))
- Support both BESU\_ and PANTHEON\_ env var prefixes [\#32](https://github.com/idnecology/idn/pull/32)
- Use only fully validated peers for fast sync pivot selection [\#21](https://github.com/idnecology/idn/pull/21)
- Support Version Rollbacks for RocksDB \(\#6\) [\#19](https://github.com/idnecology/idn/pull/19)
- Update Cava library to Tuweni Library [\#18](https://github.com/idnecology/idn/pull/18)
- StateTrieAccountValue:Version should be written as an int, not a long [\#17](https://github.com/idnecology/idn/pull/17)
- Handle discovery peers with updated endpoints [\#12](https://github.com/idnecology/idn/pull/12)
- Change retesteth port [\#11](https://github.com/idnecology/idn/pull/11)
- Renames eea\_getTransactionReceipt to priv\_getTransactionReceipt [\#10](https://github.com/idnecology/idn/pull/10) (thanks to [josh-richardson](https://github.com/josh-richardson))
- Support Version Rollbacks for RocksDB [\#6](https://github.com/idnecology/idn/pull/6)
- Moving AT DSL into its own module [\#3](https://github.com/idnecology/idn/pull/3)
...
- [GraphQL](https://idn.idnecology.org/en/latest/HowTo/Interact/APIs/GraphQL/) [\#1311](https://github.com/PegaSysEng/pantheon/pull/1311) (thanks to [zyfrank](https://github.com/zyfrank))
- Added [`--tx-pool-retention-hours`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#tx-pool-retention-hours) [\#1333](https://github.com/PegaSysEng/pantheon/pull/1333)
...
- [Privacy](https://idn.idnecology.org/en/latest/Concepts/Privacy/Privacy-Overview/)
- [Onchain Permissioning](https://idn.idnecology.org/en/latest/Concepts/Permissioning/Permissioning-Overview/#onchain)
- [Fastsync](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#fast-sync-min-peers)
...
### Additions and Improvements
- [IBFT 2.0](https://idn.idnecology.org/en/latest/Tutorials/Private-Network/Create-IBFT-Network/)
- [Permissioning](https://idn.idnecology.org/en/latest/Concepts/Permissioning/Permissioning-Overview/)
- [JSON-RPC Authentication](https://idn.idnecology.org/en/latest/HowTo/Interact/APIs/Authentication/)
...
The [documentation](https://docs.pantheon.pegasys.tech/en/latest/) has been updated throughout to use the changed command line options and the [command line reference](https://idn.idnecology.org/en/stable/) documents the changed options.

| Previous Option                     | New Option                                                                                                                                                                                                                                  | Change                            |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| `--config`                          | [`--config-file`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#config-file)                                                                                                                                  | Renamed                          |
| `--datadir`                         | [`--data-path`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#data-path)                                                                                                                                      | Renamed                          |
| `--dev-mode`                        | [`--network=dev`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#network)                                                                                                                                     | Replaced by `--network` option   |
| `--genesis`                         | [`--genesis-file`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#genesis-file)                                                                                                                                | Renamed                          |
| `--goerli`                          | [`--network=goerli`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#network)                                                                                                                                  | Replaced by `--network` option   |
| `--metrics-listen=<HOST:PORT>`      | [`--metrics-host=<HOST>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#metrics-host) and [`--metrics-port=<PORT>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#metrics-port) | Split into host and port options |
| `--miner-extraData`                 | [`--miner-extra-data`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#miner-extra-data)                                                                                                                       | Renamed                          |
| `--miner-minTransactionGasPriceWei` | [`--min-gas-price`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#min-gas-price)                                                                                                                              | Renamed                          |
| `--no-discovery`                    | [`--discovery-enabled`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#discovery-enabled)                                                                                                                      | Replaced                         |
| `--node-private-key`                | [`--node-private-key-file`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#node-private-key-file)                                                                                                              | Renamed                          |
| `--ottoman`                         | N/A                                                                                                                                                                                                                                         | Removed                          |
| `--p2p-listen=<HOST:PORT>`          | [`--p2p-host=<HOST>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#p2p-hostt) and [`--p2p-port=<PORT>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#p2p-port) | Split into host and port options |
| `--rinkeby`                         | [`--network=rinkeby`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#network)                                                                                                                                     | Replaced by `--network` option   |
| `--ropsten`                         | [`--network=ropsten`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#network)                                                                                                                                     | Replaced by `--network` option   |
| `--rpc-enabled`                     | [` --rpc-http-enabled`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-http-enabled)| Renamed|
| `--rpc-listen=<HOST:PORT>`          | [`--rpc-http-host=<HOST>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-http-host) and [`--rpc-http-port=<PORT>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-http-port) | Split into host and port options |
| `--rpc-api`                         | [`--rpc-http-api`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-http-api)| Renamed |
| `--rpc-cors-origins`                | [`--rpc-http-cors-origins`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-http-cors-origins) | Renamed |
| `--ws-enabled`                      | [`--rpc-ws-enabled`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-ws-enabled)  | Renamed |
| `--ws-api`                          | [`--rpc-ws-api`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-ws-api) | Renamed|
| `--ws-listen=<HOST:PORT>`           | [`--rpc-ws-host=<HOST>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-ws-host) and [`--rpc-ws-port=<PORT>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-ws-port) | Split into host and port options |
| `--ws-refresh-delay`                | [`--rpc-ws-refresh-delay`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Syntax/#rpc-ws-refresh-delay)|Renamed|

| Previous Subcommand                 | New Subcommand                                                                                                                                                                                                                  | Change                            |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| `pantheon import <block-file>`      | [`pantheon blocks import --from=<block-file>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Subcommands/#blocks)                                                                                            | Renamed                          |
| `pantheon export-pub-key <key-file>`| [`pantheon public-key export --to=<key-file>`](https://idn.idnecology.org/en/latest/Reference/CLI/CLI-Subcommands/#public-key)                                                                                                      | Renamed                          |


### Private Network Quickstart

The Private Network Quickstart has been moved from the `pantheon` repository to the `pantheon-quickstart`
repository. The [Private Network Quickstart tutorial](https://idn.idnecology.org/en/latest/Tutorials/Quickstarts/Private-Network-Quickstart/)
...
specified [data directory](https://idn.idnecology.org/en/stable/),
or referring to the custom [configuration file](https://idn.idnecology.org/en/stable/)
or [genesis file](https://idn.idnecology.org/en/stable/).
...
* Save the node key in the [`key` file](https://idn.idnecology.org/en/latest/Concepts/Node-Keys/#node-private-key) in the data
    directory or specify the location using the [`--node-private-key` option](https://idn.idnecology.org/en/stable/).
* Specify the `<destination_directory` as a [volume for the data directory](https://idn.idnecology.org/en/stable/).
