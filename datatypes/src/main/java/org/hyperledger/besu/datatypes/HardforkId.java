...
public interface HardforkId {
  ...
  /**
   * Has the fork been finalized? i.e., could the definition change in future versions of Idn?
   *
  ...
  enum MainnetHardforkId implements HardforkId {
    ...
    /**
     * The most recent finalized mainnet hardfork Idn supports. This will change across versions
