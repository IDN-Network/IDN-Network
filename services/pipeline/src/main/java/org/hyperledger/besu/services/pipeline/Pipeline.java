...
import org.idnecology.idn.services.pipeline.exception.AsyncOperationException;
import org.idnecology.idn.util.ExceptionUtils;
import org.idnecology.idn.util.log.LogUtil;
...
public class Pipeline<I> {
  ...
  private final Tracer tracer =
      GlobalOpenTelemetry.getTracer("org.idnecology.idn.services.pipeline", "1.0.0");
        ...
        () -> {
          ...
          try {
            ...
            if (t instanceof CompletionException
              ...
              LOG.info(
                  LogUtil.summarizeIdnStackTrace(
