...
public class BftTransactions {
  ...
  public BftPropose createRemoveProposal(final IdnNode node) {
    return propose(node.getAddress().toString(), false);
  }

  public BftPropose createAddProposal(final IdnNode node) {
  ...
  public BftDiscard createDiscardProposal(final IdnNode node) {
