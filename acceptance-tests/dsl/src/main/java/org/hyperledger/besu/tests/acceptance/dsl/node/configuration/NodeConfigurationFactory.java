...
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.CLIQUE;
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.IBFT;
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.MINER;
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.QBFT;
...
public class NodeConfigurationFactory {
  ...
  public Optional<String> createGenesisConfigForValidators(
      ...
      final Collection<? extends RunnableNode> idnNodes,
      final GenesisConfigurationProvider genesisConfigProvider) {
    final List<RunnableNode> nodes =
        idnNodes.stream().filter(n -> validators.contains(n.getName())).collect(toList());
