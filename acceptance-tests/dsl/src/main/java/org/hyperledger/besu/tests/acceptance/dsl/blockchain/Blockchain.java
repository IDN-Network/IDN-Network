 ...
 */
package org.idnecology.idn.tests.acceptance.dsl.blockchain;

import org.idnecology.idn.tests.acceptance.dsl.condition.Condition;
import org.idnecology.idn.tests.acceptance.dsl.condition.blockchain.ExpectBeneficiary;
import org.idnecology.idn.tests.acceptance.dsl.condition.blockchain.ExpectBlockNumber;
import org.idnecology.idn.tests.acceptance.dsl.condition.blockchain.ExpectBlockNumberAbove;
import org.idnecology.idn.tests.acceptance.dsl.condition.blockchain.ExpectMinimumBlockNumber;
...
public class Blockchain {
  ...
  public Condition beneficiaryEquals(final IdnNode node) {
  ...
  public Condition reachesHeight(final IdnNode node, final int blocksAheadOfLatest) {
    return new ExpectBlockNumberAbove(eth, futureHeight(node, blocksAheadOfLatest));
  }

  public Condition reachesHeight(
      final IdnNode node, final int blocksAheadOfLatest, final int timeout) {
