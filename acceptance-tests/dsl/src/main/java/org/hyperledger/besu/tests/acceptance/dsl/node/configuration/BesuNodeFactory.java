...
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.ADMIN;
import static org.idnecology.idn.ethereum.api.jsonrpc.RpcApis.IBFT;
...
import org.idnecology.idn.tests.acceptance.dsl.node.configuration.genesis.GenesisConfigurationFactory;
import org.idnecology.idn.tests.acceptance.dsl.node.configuration.genesis.GenesisConfigurationFactory.CliqueOptions;
...
public class IdnNodeFactory {

  private final NodeConfigurationFactory node = new NodeConfigurationFactory();

  public IdnNode create(final IdnNodeConfiguration config) throws IOException {
    return new IdnNode(
        config.getName(),
        config.getDataPath(),
  ...
  public IdnNode createMinerNode(
      final String name, final UnaryOperator<IdnNodeConfigurationBuilder> configModifier)
      throws IOException {
    IdnNodeConfigurationBuilder builder =
        new IdnNodeConfigurationBuilder()
            .name(name)
            .miningEnabled()
            .jsonRpcEnabled()
            .webSocketEnabled();
    builder = configModifier.apply(builder);
    final IdnNodeConfiguration config = builder.build();

    return create(config);
  }

  public IdnNode createMinerNodeWithExtraCliOptions(
      final String name,
      final UnaryOperator<IdnNodeConfigurationBuilder> configModifier,
  ...
  public IdnNode createMinerNode(final String name) throws IOException {
  ...
  public IdnNode createMinerNodeWithRevertReasonEnabled(final String name) throws IOException {
    return createMinerNode(name, IdnNodeConfigurationBuilder::revertReasonEnabled);
  }

  public IdnNode createArchiveNode(final String name) throws IOException {
    return createArchiveNode(name, UnaryOperator.identity());
  }

  public IdnNode createArchiveNode(
      final String name, final UnaryOperator<IdnNodeConfigurationBuilder> configModifier)
      throws IOException {
    IdnNodeConfigurationBuilder builder =
        new IdnNodeConfigurationBuilder()
  ...
  public IdnNode createNode(
      final String name, final UnaryOperator<IdnNodeConfigurationBuilder> configModifier)
      throws IOException {
    final IdnNodeConfigurationBuilder configBuilder =
        configModifier.apply(new IdnNodeConfigurationBuilder().name(name));
  ...
  public IdnNode createArchiveNodeWithDiscoveryDisabledAndAdmin(final String name)
      throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
  ...
  public IdnNode createArchiveNodeNetServicesEnabled(final String name) throws IOException {
  ...
  public IdnNode createArchiveNodeNetServicesDisabled(final String name) throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
            .jsonRpcConfiguration(node.jsonRpcConfigWithAdmin())
  ...
  public IdnNode createNodeWithAuthentication(final String name, final String authFile)
  ...
  public IdnNode createNodeWithAuthFileAndNoAuthApi(
  ...
  public IdnNode createWsNodeWithAuthFileAndNoAuthApi(
      final String name, final String authFile, final List<String> noAuthApiMethods)
      throws URISyntaxException, IOException {
    return create(
        new IdnNodeConfigurationBuilder()
  ...
  public IdnNode createNodeWithAuthenticationUsingRsaJwtPublicKey(final String name)
      throws IOException, URISyntaxException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
  ...
  public IdnNode createNodeWithAuthenticationUsingEcdsaJwtPublicKey(final String name)
      throws IOException, URISyntaxException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
  ...
  public IdnNode createNodeWithP2pDisabled(final String name) throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
            .p2pEnabled(false)
  ...
  public IdnNode createArchiveNodeWithRpcDisabled(final String name) throws IOException {
    return create(new IdnNodeConfigurationBuilder().name(name).build());
  }

  public IdnNode createPluginsNode(
      final String name,
  ...
  public IdnNode createArchiveNodeWithRpcApis(final String name, final String... enabledRpcApis)
      throws IOException {
  ...
  public IdnNode createNodeWithNoDiscovery(final String name) throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
            .discoveryEnabled(false)
  ...
  public IdnNode createCliqueNode(final String name) throws IOException {
    return createCliqueNode(name, CliqueOptions.DEFAULT);
  }

  public IdnNode createCliqueNode(final String name, final CliqueOptions cliqueOptions)
      throws IOException {
    return createCliqueNodeWithExtraCliOptionsAndRpcApis(name, cliqueOptions, List.of());
  }

  public IdnNode createCliqueNodeWithExtraCliOptionsAndRpcApis(
  ...
  public IdnNode createIbft2NonValidatorBootnode(final String name, final String genesisFile)
      throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
  ...
  public IdnNode createIbft2NodeWithLocalAccountPermissioning(
      final String name,
  ...
  public IdnNode createIbft2Node(final String name, final String genesisFile) throws IOException {
    return create(
        new IdnNodeConfigurationBuilder()
            .name(name)
            .miningEnabled()
  ...
  public IdnNode createIbft2Node(
  ...
  public IdnNode createQbftMigrationNode(
      final String name, final boolean fixedPort, final DataStorageFormat storageFormat)
      throws IOException {
    JsonRpcConfiguration rpcConfig = node.createJsonRpcWithQbftEnabledConfig(false);
    rpcConfig.addRpcApi("ADMIN,TXPOOL");
  ...
  public IdnNode createCustomGenesisNode(
  ...
  public IdnNode createCustomGenesisNode(
    ...
    final IdnNodeConfigurationBuilder builder =
        new IdnNodeConfigurationBuilder()
            .name(name)
            .jsonRpcEnabled()
            .webSocketEnabled()
  ...
  public IdnNode createExecutionEngineGenesisNode(final String name, final String genesisPath)
      throws IOException {
    final String genesisFile = GenesisConfigurationFactory.readGenesisFile(genesisPath);
  ...
  public IdnNode createCliqueNodeWithValidators(final String name, final String... validators)
      throws IOException {
    return createCliqueNodeWithValidators(name, CliqueOptions.DEFAULT, validators);
  }

  public IdnNode createCliqueNodeWithValidators(
  ...
  public IdnNode createIbft2NodeWithValidators(final String name, final String... validators)
      throws IOException {
  ...
  public IdnNode createQbftTLSNodeWithValidators(
  ...
  public IdnNode createQbftNodeWithValidators(final String name, final String... validators)
      throws IOException {
  ...
  public IdnNode createQbftNodeWithContractBasedValidators(
  ...
  public IdnNode createNodeWithStaticNodes(final String name, final List<Node> staticNodes)
      throws IOException {
  ...
  private IdnNodeConfigurationBuilder createConfigurationBuilderWithStaticNodes(
    ...
    return new IdnNodeConfigurationBuilder()
        .name(name)
        .jsonRpcEnabled()
        .webSocketEnabled()
        .discoveryEnabled(false)
  ...
  public IdnNode createNodeWithNonDefaultSignatureAlgorithm(
  ...
  public IdnNodeConfigurationBuilder createNodeConfigurationWithNonDefaultSignatureAlgorithm(
      final String name,
      final String genesisPath,
      final KeyPair keyPair,
      final List<Node> staticNodes) {
  ...
  public IdnNode runCommand(final String command) throws IOException {
    return create(new IdnNodeConfigurationBuilder().name("run " + command).run(command).build());
  }
}
