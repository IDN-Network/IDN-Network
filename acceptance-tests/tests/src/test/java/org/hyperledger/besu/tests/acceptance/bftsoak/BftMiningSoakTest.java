 ...
 */
package org.idnecology.idn.tests.acceptance.bftsoak;

import static org.assertj.core.api.Assertions.assertThat;

import org.idnecology.idn.config.JsonUtil;
import org.idnecology.idn.tests.acceptance.bft.BftAcceptanceTestParameterization;
import org.idnecology.idn.tests.acceptance.bft.ParameterizedBftTestBase;
import org.idnecology.idn.tests.acceptance.dsl.node.IdnNode;
import org.idnecology.idn.tests.web3j.generated.SimpleStorage;
import org.idnecology.idn.tests.web3j.generated.SimpleStorageShanghai;
...
public class BftMiningSoakTest extends ParameterizedBftTestBase {
  ...
  public void shouldBeStableDuringLongTest(
    ...
    final IdnNode minerNode1 = nodeFactory.createBonsaiNodeFixedPort(idn, "miner1");
    final IdnNode minerNode2 = nodeFactory.createForestNodeFixedPort(idn, "miner2");
    final IdnNode minerNode3 = nodeFactory.createBonsaiNodeFixedPort(idn, "miner3");
    final IdnNode minerNode4 = nodeFactory.createForestNodeFixedPort(idn, "miner4");
  ...
  private static void updateGenesisConfigToLondon(
      final IdnNode minerNode, final boolean zeroBaseFeeEnabled, final int blockNumber) {
  ...
  private static void updateGenesisConfigToShanghai(
      final IdnNode minerNode, final long blockTimestamp) {
  ...
  private void startNode(final IdnNode node) throws InterruptedException {
    cluster.startNode(node);
    Thread.sleep(TEN_SECONDS);
  }

  // Stop a node with a delay before returning to give it time to stop
  private void stopNode(final IdnNode node) throws InterruptedException {
