...
public class CliqueMiningAcceptanceTest extends AcceptanceTestBase {
  ...
  public void shouldMineTransactionsOnSingleNode() throws IOException {
    final IdnNode minerNode = idn.createCliqueNode("miner1");
  ...
  public void shouldNotMineBlocksIfNoTransactionsWhenCreateEmptyBlockIsFalse() throws IOException {
    ...
    final IdnNode minerNode = idn.createCliqueNode("miner1", cliqueOptionsNoEmptyBlocks);
    cluster.start(minerNode);
  ...
  public void shouldMineTransactionsOnMultipleNodes() throws IOException {
    final IdnNode minerNode1 = idn.createCliqueNode("miner1");
    final IdnNode minerNode2 = idn.createCliqueNode("miner2");
    final IdnNode minerNode3 = idn.createCliqueNode("miner3");
  ...
  private void startClusterAndVerifyProducingBlocks(
      final IdnNode minerNode1, final IdnNode minerNode2, final IdnNode minerNode3) {
  ...
  public void shouldMineBlocksAccordingToBlockPeriodTransitions() throws IOException {
    ...
    final IdnNode minerNode = idn.createCliqueNode("miner1", cliqueOptions);
  ...
  public void shouldMineBlocksAccordingToCreateEmptyBlocksTransitions() throws IOException {
    ...
    final IdnNode minerNode = idn.createCliqueNode("miner1", cliqueOptionsEmptyBlocks);
  ...
  private long getTimestampForBlock(final IdnNode minerNode, final int blockNumber) {
    return minerNode
        .execute(
