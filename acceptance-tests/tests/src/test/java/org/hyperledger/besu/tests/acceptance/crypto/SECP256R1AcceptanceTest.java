 ...
 */
package org.idnecology.idn.tests.acceptance.crypto;

import static org.assertj.core.api.Assertions.assertThat;
import static org.junit.jupiter.api.Assumptions.assumeTrue;

import org.idnecology.idn.crypto.KeyPair;
import org.idnecology.idn.crypto.SECP256R1;
...
public class SECP256R1AcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws Exception {
    ...
    minerNode =
        idn.createNodeWithNonDefaultSignatureAlgorithm(
  ...
  public void transactionShouldBeSuccessful() {
    // SignatureAlgorithmFactory.instance is static. When ThreadIdnRunner is used, we cannot change
    // the signature algorithm instance to SECP256R1 as it could influence other tests running at
    // the same time. So we only execute the test when ProcessIdnNodeRunner is used, as there is
    // not conflict because we use separate processes.
    assumeTrue(IdnNodeRunner.isProcessIdnNodeRunner());
