...
public class EthSendRawTransactionAcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws Exception {
    ...
    lenientNode = idn.createArchiveNode("lenientNode", configureNode((false)));
    strictNode = idn.createArchiveNode("strictNode", configureNode((true)));
    miningNode = idn.createMinerNode("strictMiningNode", configureNode((true)));
  ...
  private UnaryOperator<IdnNodeConfigurationBuilder> configureNode(
