...
public class BftBlockRewardPaymentAcceptanceTest extends ParameterizedBftTestBase {
  ...
  public void validatorsArePaidBlockReward(
    ...
    final IdnNode validator = nodeFactory.createNodeWithValidators(idn, "validator", validators);
    final IdnNode nonValidator =
        nodeFactory.createNodeWithValidators(idn, "nonValidator", validators);
