...
public class PragueAcceptanceTestHelper {
  ...
  private final IdnNode idnNode;
  private final EthTransactions ethTransactions;

  private long blockTimeStamp = 0;

  PragueAcceptanceTestHelper(final IdnNode idnNode, final EthTransactions ethTransactions) {
    this.idnNode = idnNode;
  ...
  public void buildNewBlock() throws IOException {
    final EthBlock.Block block = idnNode.execute(ethTransactions.block());
