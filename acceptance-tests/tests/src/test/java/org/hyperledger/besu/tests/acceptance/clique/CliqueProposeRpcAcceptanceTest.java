...
public class CliqueProposeRpcAcceptanceTest extends AcceptanceTestBase {
  ...
  public void shouldAddAndRemoveValidators() throws IOException {
    ...
    final IdnNode minerNode1 =
        idn.createCliqueNodeWithValidators("miner1", CLIQUE_OPTIONS, initialValidators);
    final IdnNode minerNode2 =
        idn.createCliqueNodeWithValidators("miner2", CLIQUE_OPTIONS, initialValidators);
    final IdnNode minerNode3 =
        idn.createCliqueNodeWithValidators("miner3", CLIQUE_OPTIONS, initialValidators);
  ...
  private void waitForNodesConnectedAndInSync(final IdnNode... nodes) {
