 ...
 */
package org.idnecology.idn.tests.acceptance.pubsub;
...
import org.idnecology.idn.tests.acceptance.dsl.pubsub.Subscription;
import org.idnecology.idn.tests.acceptance.dsl.pubsub.WebSocket;
...
public class NewPendingTransactionAcceptanceTest extends AcceptanceTestBase {
  ...
  private IdnNode archiveNode;

  @BeforeEach
  public void setUp() throws Exception {
    vertx = Vertx.vertx();
    minerNode = idn.createMinerNode("miner-node1");
    archiveNode = idn.createArchiveNode("full-node1");
