...
public class NodeLocalConfigPermissioningAcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws Exception {
    ...
    bootnode = idn.createArchiveNode("bootnode");
    forbiddenNode = idn.createArchiveNodeThatMustNotBeTheBootnode("forbidden-node");
    allowedNode = idn.createArchiveNode("allowed-node");
