...
import org.idnecology.idn.tests.web3j.generated.EventEmitter;
import org.idnecology.idn.tests.web3j.generated.EventEmitter.StoredEventResponse;
...
public class EventEmitterAcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws Exception {
    node = idn.createMinerNode("node1");
    cluster.start(node);
  }
