...
import org.idnecology.idn.ethereum.permissioning.account.TransactionPermissioningProvider;
...
public class TransactionSmartContractPermissioningController
  ...
  public boolean isPermitted(final Transaction transaction) {
    final org.idnecology.idn.datatypes.Hash transactionHash = transaction.getHash();
