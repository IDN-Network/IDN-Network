...
import static org.idnecology.idn.ethereum.blockcreation.AbstractBlockTransactionSelectorTest.Sender.SENDER1;
import static org.idnecology.idn.ethereum.blockcreation.AbstractBlockTransactionSelectorTest.Sender.SENDER2;
import static org.idnecology.idn.ethereum.blockcreation.AbstractBlockTransactionSelectorTest.Sender.SENDER3;
import static org.idnecology.idn.ethereum.blockcreation.AbstractBlockTransactionSelectorTest.Sender.SENDER4;
import static org.idnecology.idn.ethereum.blockcreation.AbstractBlockTransactionSelectorTest.Sender.SENDER5;
import static org.idnecology.idn.ethereum.core.MiningConfiguration.DEFAULT_NON_POA_BLOCK_TXS_SELECTION_MAX_TIME;
import static org.idnecology.idn.ethereum.transaction.TransactionInvalidReason.EXECUTION_INTERRUPTED;
import static org.idnecology.idn.ethereum.transaction.TransactionInvalidReason.NONCE_TOO_LOW;
import static org.idnecology.idn.plugin.data.TransactionSelectionResult.BLOCK_SELECTION_TIMEOUT;
import static org.idnecology.idn.plugin.data.TransactionSelectionResult.BLOCK_SELECTION_TIMEOUT_INVALID_TX;
import static org.idnecology.idn.plugin.data.TransactionSelectionResult.PRIORITY_FEE_PER_GAS_BELOW_CURRENT_MIN;
import static org.idnecology.idn.plugin.data.TransactionSelectionResult.SELECTED;
import static org.idnecology.idn.plugin.data.TransactionSelectionResult.TX_EVALUATION_TOO_LONG;
...
import org.idnecology.idn.plugin.services.txselection.PluginTransactionSelectorFactory;
import org.idnecology.idn.plugin.services.txselection.SelectorsStateManager;
import org.idnecology.idn.plugin.services.txselection.TransactionEvaluationContext;
...
public abstract class AbstractBlockTransactionSelectorTest {
    ...
    final PluginTransactionSelector pluginTransactionSelector =
        new PluginTransactionSelector() {
          ...
          public TransactionSelectionResult evaluateTransactionPostProcessing(
              final TransactionEvaluationContext evaluationContext,
              final org.idnecology.idn.plugin.data.TransactionProcessingResult processingResult) {
            return SELECTED;
          }
        };
  ...
  private void internalBlockSelectionTimeoutSimulation(
    ...
    final BiFunction<Transaction, Long, Answer<TransactionSelectionResult>> tooLate =
        (p, t) ->
            invocation -> {
              final org.idnecology.idn.ethereum.blockcreation.txselection
