...
public class TxPoolIdnPendingTransactionsTest {

  @Mock private TransactionPool transactionPool;
  private TxPoolIdnPendingTransactions method;
  private final String JSON_RPC_VERSION = "2.0";
  private final String TXPOOL_PENDING_TRANSACTIONS_METHOD = "txpool_idnPendingTransactions";
  private Set<PendingTransaction> listTrx;

  @BeforeEach
  public void setUp() {
    listTrx = getTransactionPool();
    method = new TxPoolIdnPendingTransactions(transactionPool);
