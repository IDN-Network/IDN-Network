...
import org.idnecology.idn.ethereum.api.jsonrpc.internal.results.PendingTransactionsStatisticsResult;
...
public class TxPoolIdnStatisticsTest {

  @Mock private TransactionPool transactionPool;
  private TxPoolIdnStatistics method;
  private final String JSON_RPC_VERSION = "2.0";
  private final String TXPOOL_PENDING_TRANSACTIONS_METHOD = "txpool_idnStatistics";

  @BeforeEach
  public void setUp() {
    method = new TxPoolIdnStatistics(transactionPool);
  }
