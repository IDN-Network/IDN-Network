...
import static org.idnecology.idn.crypto.SecureRandomProvider.createSecureRandom;
...
public final class TlsOkHttpClientBuilder {
  private SelfSignedP12Certificate idnCertificate;
  ...
  public TlsOkHttpClientBuilder withIdnCertificate(
      final SelfSignedP12Certificate idnCertificate) {
    this.idnCertificate = idnCertificate;
    return this;
  }
    ...
    try {
      final KeyStore trustStore =
          KeyStore.getInstance(
              idnCertificate.getTrustStoreFile().toFile(), idnCertificate.getPassword());
