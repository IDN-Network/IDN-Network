...
import org.idnecology.idn.ethereum.api.jsonrpc.internal.results.PendingTransactionResult;
...
public class TxPoolIdnTransactionsTest {

  @Mock private TransactionPool transactionPool;
  private TxPoolIdnTransactions method;
  private final String JSON_RPC_VERSION = "2.0";
  private final String TXPOOL_PENDING_TRANSACTIONS_METHOD = "txpool_idnTransactions";
  private static final String TRANSACTION_HASH =
      "0xbac263fb39f2a51053fb5e1e52aeb4e980fba9e151aa7e4f12eca95a697aeac9";

  @BeforeEach
  public void setUp() {
    method = new TxPoolIdnTransactions(transactionPool);
  }
