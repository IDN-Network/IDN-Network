...
import static org.idnecology.idn.ethereum.api.jsonrpc.authentication.AuthenticationUtils.truncToken;

import org.idnecology.idn.ethereum.api.handlers.HandlerFactory;
...
import org.idnecology.idn.ethereum.api.jsonrpc.execution.TimedJsonRpcProcessor;
import org.idnecology.idn.ethereum.api.jsonrpc.execution.TracedJsonRpcProcessor;
import org.idnecology.idn.ethereum.api.jsonrpc.health.HealthService;
import org.idnecology.idn.ethereum.api.jsonrpc.internal.exception.Logging403ErrorHandler;
...
import org.idnecology.idn.ethereum.api.tls.TlsClientAuthConfiguration;
...
import org.idnecology.idn.util.ExceptionUtils;
...
public class EngineJsonRpcService {
  ...
  public CompletableFuture<Void> start() {
    ...
    if (this.tracerProvider != null) {
      this.tracer = tracerProvider.get("org.idnecology.idn.jsonrpc", "1.0.0");
    } else {
      this.tracer = OpenTelemetry.noop().getTracer("org.idnecology.idn.jsonrpc", "1.0.0");
    }
