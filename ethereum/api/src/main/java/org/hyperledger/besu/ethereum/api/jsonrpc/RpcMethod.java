...
public enum RpcMethod {
  ...
  TX_POOL_BESU_STATISTICS("txpool_idnStatistics"),
  TX_POOL_BESU_TRANSACTIONS("txpool_idnTransactions"),
  TX_POOL_BESU_PENDING_TRANSACTIONS("txpool_idnPendingTransactions"),
