 ...
 */
package org.idnecology.idn.ethereum.api.jsonrpc.internal.response;

import org.idnecology.idn.plugin.services.rpc.RpcMethodError;
...
public enum RpcErrorType implements RpcMethodError {
  ...
  ETH_SEND_TX_NOT_AVAILABLE(
      -32604,
      "The method eth_sendTransaction is not supported. Use eth_sendRawTransaction to send a signed transaction to Idn."),
