...
import org.idnecology.idn.ethereum.api.jsonrpc.internal.methods.TxPoolIdnPendingTransactions;
import org.idnecology.idn.ethereum.api.jsonrpc.internal.methods.TxPoolIdnStatistics;
import org.idnecology.idn.ethereum.api.jsonrpc.internal.methods.TxPoolIdnTransactions;
...
public class TxPoolJsonRpcMethods extends ApiGroupJsonRpcMethods {
  ...
  protected Map<String, JsonRpcMethod> create() {
    return mapOf(
        new TxPoolIdnTransactions(transactionPool),
        new TxPoolIdnPendingTransactions(transactionPool),
        new TxPoolIdnStatistics(transactionPool));
  }
}
