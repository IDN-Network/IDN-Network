 ...
 */
package org.idnecology.idn.ethereum.stratum;
...
public class StratumServer implements PoWObserver {
  ...
  public StratumServer(
    ...
    metricsSystem.createLongGauge(
        IdnMetricCategory.STRATUM, "miners", "Number of miners connected", numberOfMiners::get);
    metricsSystem.createGauge(
        IdnMetricCategory.STRATUM,
        "difficulty",
        "Current mining difficulty",
        currentDifficulty::get);
    this.connectionsCount =
        metricsSystem.createCounter(
            IdnMetricCategory.STRATUM, "connections", "Number of connections over time");
    this.disconnectionsCount =
        metricsSystem.createCounter(
            IdnMetricCategory.STRATUM, "disconnections", "Number of disconnections over time");
  }
