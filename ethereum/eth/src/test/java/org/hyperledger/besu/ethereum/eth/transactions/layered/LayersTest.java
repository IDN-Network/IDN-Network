...
import static org.idnecology.idn.datatypes.TransactionType.ACCESS_LIST;
import static org.idnecology.idn.datatypes.TransactionType.BLOB;
import static org.idnecology.idn.datatypes.TransactionType.DELEGATE_CODE;
import static org.idnecology.idn.datatypes.TransactionType.EIP1559;
import static org.idnecology.idn.datatypes.TransactionType.FRONTIER;
import static org.idnecology.idn.ethereum.core.TransactionTestFixture.createSignedCodeDelegation;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayeredRemovalReason.PoolRemovalReason.INVALIDATED;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.AuthorityAndNonce.NO_DELEGATIONS;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.AuthorityAndNonce.delegation;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.AuthorityAndNonce.toCodeDelegations;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.S1;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.S2;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.S3;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.S4;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.SP1;
import static org.idnecology.idn.ethereum.eth.transactions.layered.LayersTest.Sender.SP2;
...
import org.idnecology.idn.ethereum.eth.transactions.TransactionPoolReplacementHandler;
