 ...
 */
package org.idnecology.idn.ethereum.eth.encoding;

import org.idnecology.idn.datatypes.Hash;
import org.idnecology.idn.datatypes.TransactionType;
import org.idnecology.idn.ethereum.eth.EthProtocolVersion;
import org.idnecology.idn.ethereum.eth.transactions.TransactionAnnouncement;
...
public class TransactionAnnouncementDecoder {
  ...
  private static List<TransactionAnnouncement> decodeForEth68(final RLPInput input) {
    ...
    List<Long> sizes =
        input.readList(
            in -> {
              // for backward compatibility with previous Idn implementation be lenient and support
              // also unsigned int with leading zeros.
              // ToDo: this could be replaced with the simpler `RLPInput::readUnsignedIntScalar`
              // after some months it has been released, since most of the Idns
