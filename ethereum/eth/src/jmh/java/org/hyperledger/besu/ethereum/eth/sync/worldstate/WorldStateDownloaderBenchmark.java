 ...
 */
package org.idnecology.idn.ethereum.eth.sync.worldstate;
...
import org.idnecology.idn.ethereum.eth.manager.RespondingEthPeer.Responder;
...
import org.idnecology.idn.ethereum.eth.sync.fastsync.worldstate.FastWorldStateDownloader;
import org.idnecology.idn.ethereum.eth.sync.fastsync.worldstate.NodeDataRequest;
...
public class WorldStateDownloaderBenchmark {
  ...
  private StorageProvider createKeyValueStorageProvider(final Path dataDir, final Path dbDir) {
    ...
    idnConfiguration.init(dataDir, dbDir, DataStorageConfiguration.DEFAULT_CONFIG);
