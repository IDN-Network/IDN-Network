...
import org.idnecology.idn.ethereum.p2p.discovery.internal.PeerDiscoveryController;
...
import org.idnecology.idn.ethereum.p2p.discovery.internal.TimerUtil;
import org.idnecology.idn.ethereum.p2p.discovery.internal.VertxTimerUtil;
...
import org.idnecology.idn.ethereum.p2p.discovery.internal.packet.PacketDeserializer;
import org.idnecology.idn.ethereum.p2p.discovery.internal.packet.PacketPackage;
import org.idnecology.idn.ethereum.p2p.discovery.internal.packet.PacketSerializer;
  ...
  protected CompletableFuture<Void> sendOutgoingPacket(
    ...
    if (socket == null) {
      result.completeExceptionally(
          new RuntimeException("Discovery socket already closed, because Idn is closing down"));
    } else {
      socket.send(
