...
import org.idnecology.idn.ethereum.privacy.PrivateTransactionWithMetadata;
import org.idnecology.idn.ethereum.privacy.VersionedPrivateTransaction;
...
public class PrivateTransactionDataFixture {
  ...
  public static PrivateTransaction privateTransactionIdn() {
    return new PrivateTransactionTestFixture()
        .privacyGroupId(VALID_BASE64_ENCLAVE_KEY)
        .createTransaction(KEY_PAIR);
  }

  public static VersionedPrivateTransaction versionedPrivateTransactionIdn() {
    return new PrivateTransactionTestFixture()
        .privacyGroupId(VALID_BASE64_ENCLAVE_KEY)
        .createVersionedPrivateTransaction((KEY_PAIR));
  }

  public static PrivateTransaction privateContractDeploymentTransactionIdn() {
    return new PrivateTransactionTestFixture()
        .payload(VALID_CONTRACT_DEPLOYMENT_PAYLOAD)
        .privacyGroupId(VALID_BASE64_ENCLAVE_KEY)
        .createTransaction(KEY_PAIR);
