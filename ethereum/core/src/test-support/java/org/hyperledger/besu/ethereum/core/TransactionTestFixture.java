...
import org.idnecology.idn.crypto.CodeDelegationSignature;
...
import org.idnecology.idn.ethereum.core.encoding.CodeDelegationTransactionEncoder;
...
public class TransactionTestFixture {
  ...
  private static final org.idnecology.idn.datatypes.CodeDelegation CODE_DELEGATION =
  ...
  private Optional<List<org.idnecology.idn.datatypes.CodeDelegation>> codeDelegations =
      Optional.empty();
  ...
  public TransactionTestFixture codeDelegations(
      final List<org.idnecology.idn.datatypes.CodeDelegation> codeDelegations) {
  ...
  public static CodeDelegation createSignedCodeDelegation(
    ...
    CodeDelegationTransactionEncoder.encodeSingleCodeDelegationWithoutSignature(
        new org.idnecology.idn.ethereum.core.CodeDelegation(chainId, address, nonce, null),
        rlpOutput);

    final Hash hash =
        Hash.hash(
            Bytes.concatenate(
                org.idnecology.idn.ethereum.core.CodeDelegation.MAGIC, rlpOutput.encoded()));

    final var signature = SIGNATURE_ALGORITHM.get().sign(hash, keys);

    return new org.idnecology.idn.ethereum.core.CodeDelegation(
        chainId,
        address,
        nonce,
