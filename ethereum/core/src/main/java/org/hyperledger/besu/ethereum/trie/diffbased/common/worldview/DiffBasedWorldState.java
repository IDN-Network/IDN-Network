...
import static org.idnecology.idn.ethereum.trie.diffbased.common.storage.DiffBasedWorldStateKeyValueStorage.WORLD_BLOCK_HASH_KEY;
...
import org.idnecology.idn.ethereum.trie.diffbased.common.storage.DiffBasedSnapshotWorldStateKeyValueStorage;
  ...
  public void persist(final BlockHeader blockHeader) {
    ...
    try {
      ...
      if (blockHeader == null || !worldStateConfig.isTrieDisabled()) {
        ...
        // can be used in cases where Idn would just be a follower of another trusted client.
