  ...
  public TrieLogPruner(
    ...
    this.addedToPruneQueueCounter =
        metricsSystem.createCounter(
            IdnMetricCategory.PRUNER,
            "trie_log_added_to_prune_queue",
            "trie log added to prune queue");
    this.prunedFromQueueCounter =
        metricsSystem.createCounter(
            IdnMetricCategory.PRUNER, "trie_log_pruned_from_queue", "trie log pruned from queue");
    this.prunedOrphanCounter =
        metricsSystem.createCounter(
            IdnMetricCategory.PRUNER, "trie_log_pruned_orphan", "trie log pruned orphan");
  }
