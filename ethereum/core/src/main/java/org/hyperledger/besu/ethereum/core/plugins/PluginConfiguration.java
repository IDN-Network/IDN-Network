 ...
 */
package org.idnecology.idn.ethereum.core.plugins;
...
public class PluginConfiguration {
  ...
  public static Path defaultPluginsDir() {
    String pluginsDirProperty = System.getProperty("idn.plugins.dir");
    return pluginsDirProperty == null
        ? Paths.get(System.getProperty("idn.home", "."), "plugins")
