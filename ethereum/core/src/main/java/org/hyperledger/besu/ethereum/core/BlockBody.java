...
public class BlockBody implements org.idnecology.idn.plugin.data.BlockBody {
   ...
   * {@link org.idnecology.idn.ethereum.eth.manager.task.GetBodiesFromPeerTask.BodyIdentifier}
   * Also requires adding the new field to the constructor used in the {@link
   * org.idnecology.idn.ethereum.util.RawBlockIterator }
   */
