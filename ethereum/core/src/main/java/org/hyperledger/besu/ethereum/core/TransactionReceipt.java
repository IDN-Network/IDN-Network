 ...
 */
public class TransactionReceipt implements org.idnecology.idn.plugin.data.TransactionReceipt {
   ...
   */
  @Override
  public List<? extends org.idnecology.idn.plugin.data.Log> getLogs() {
