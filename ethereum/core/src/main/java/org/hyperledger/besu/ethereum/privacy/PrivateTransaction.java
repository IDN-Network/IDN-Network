...
import static org.idnecology.idn.plugin.data.Restriction.RESTRICTED;
import static org.idnecology.idn.plugin.data.Restriction.UNRESTRICTED;
import static org.idnecology.idn.plugin.data.Restriction.UNSUPPORTED;
...
public class PrivateTransaction implements org.idnecology.idn.plugin.data.PrivateTransaction {
  ...
  public static PrivateTransaction readFrom(
      final org.idnecology.idn.plugin.data.PrivateTransaction p) {
  ...
  public static BytesValueRLPOutput serialize(
      final org.idnecology.idn.plugin.data.PrivateTransaction t) {
