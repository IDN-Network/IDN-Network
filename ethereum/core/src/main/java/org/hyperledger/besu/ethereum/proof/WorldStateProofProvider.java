 ...
 */
package org.idnecology.idn.ethereum.proof;
...
import org.idnecology.idn.ethereum.trie.InnerNodeDiscoveryManager.InnerNode;
import org.idnecology.idn.ethereum.trie.MerkleTrie;
import org.idnecology.idn.ethereum.trie.MerkleTrieException;
import org.idnecology.idn.ethereum.trie.Proof;
import org.idnecology.idn.ethereum.trie.common.PmtStateTrieAccountValue;
import org.idnecology.idn.ethereum.trie.patricia.RemoveVisitor;
  ...
  public boolean isValidRangeProof(
    ...
    if (keys.isEmpty()) {
      ...
      try {
        ...
        // @see org.idnecology.idn.ethereum.trie.StoredNode#load()
