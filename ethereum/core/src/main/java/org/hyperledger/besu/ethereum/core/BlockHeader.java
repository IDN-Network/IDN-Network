...
public class BlockHeader extends SealableBlockHeader
    implements org.idnecology.idn.plugin.data.BlockHeader {
  ...
  public static org.idnecology.idn.ethereum.core.BlockHeader convertPluginBlockHeader(
      final org.idnecology.idn.plugin.data.BlockHeader pluginBlockHeader,
      final BlockHeaderFunctions blockHeaderFunctions) {
    return new org.idnecology.idn.ethereum.core.BlockHeader(
