...
import static org.idnecology.idn.ethereum.core.PrivateTransactionDataFixture.encodePrivateTransaction;
import static org.idnecology.idn.ethereum.core.PrivateTransactionDataFixture.generateAddToGroupReceiveResponse;
import static org.idnecology.idn.ethereum.core.PrivateTransactionDataFixture.privateTransactionIdn;
import static org.idnecology.idn.ethereum.core.PrivateTransactionDataFixture.privateTransactionLegacy;
...
import org.idnecology.idn.ethereum.core.PrivateTransactionDataFixture;
...
public class PrivateTransactionLocatorTest {
  ...
  @Test
  public void locateIdnPrivateTransactionSentToOffchainPrivacyGroup() {
    final Transaction pmt = PrivateTransactionDataFixture.privateMarkerTransaction();
  ...
  @Test
  public void locateIdnPrivateTransactionSentToFlexiblePrivacyGroup() {
  ...
  @Test
  public void locateIdnPrivateTransactionFromAddBlobSentToFlexiblePrivacyGroup() {
    final Transaction pmt = PrivateTransactionDataFixture.privateMarkerTransactionOnchain();
    final PrivateTransaction privateTransaction = privateTransactionIdn();
  ...
  @Test
  public void locateIdnPrivateTransactionNotFoundInAddBlob() {
    final Transaction pmt = PrivateTransactionDataFixture.privateMarkerTransactionOnchain();
    final PrivateTransaction privateTransaction = privateTransactionIdn();
